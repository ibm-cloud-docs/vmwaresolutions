...
* [Ordering vCenter Server instances](/docs/services/vmwaresolutions?topic=vmware-solutions-vc_orderinginstance#vc_orderinginstance-bare-metal-settings)
* [Ordering new vSphere clusters](/docs/services/vmwaresolutions?topic=vmware-solutions-vs_orderinginstances#vs_orderinginstances-bare-metal-settings)
...
For more information, see [{{site.data.keyword.cloud_notm}} Private Hosted overview](/docs/services/vmwaresolutions?topic=vmware-solutions-icp_overview).
...
For more information, see [Mission Critical VMware on {{site.data.keyword.cloud_notm}} overview](/docs/services/vmwaresolutions?topic=vmware-solutions-mcv_overview).

### F5 on IBM Cloud
{: #relnotes_v27-f5}

Now when you order the F5 on {{site.data.keyword.cloud_notm}} service, you can select whether you want F5 to apply license over public network or over private network with a proxy server. For more information, see [Ordering F5 on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions?topic=vmware-solutions-f5_ordering).

### FortiGate Virtual Appliance on IBM Cloud
{: #relnotes_v27-fva}

In 3Q 2018, Fortinet changed their subscription bundles. For more information, see [Ordering FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions?topic=vmware-solutions-fortinetvm_ordering).
...
When you order FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}}, you can select whether you want FortiGuard to apply license and security updates over public network or over private network with a proxy server. For more information, see [Ordering FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions?topic=vmware-solutions-fortinetvm_ordering).

### Zerto on IBM Cloud service component updates
{: #relnotes_v27-zerto}

For the Zerto on {{site.data.keyword.cloud_notm}} service that is deployed in V2.7 and later Cloud Foundation instances and vCenter Server instances, Zerto Virtual Replication 6.0 update 3 is provisioned. For more information, see [Zerto on {{site.data.keyword.cloud_notm}} overview](/docs/services/vmwaresolutions?topic=vmware-solutions-addingzertodr).
...
(Updated on 14 December 2018) The current version of KMIP for VMware on {{site.data.keyword.cloud_notm}} is being deprecated. For more information, [contact IBM Support](/docs/services/vmwaresolutions?topic=vmware-solutions-trbl_support).
{:deprecated}
...
* The **Customized** tab is now split into the **Skylake** and **Broadwell** tabs based on the server type to help you in server selection. This tab is where you specify CPU model and RAM for {{site.data.keyword.baremetal_short_sing}} settings when you order instances.
