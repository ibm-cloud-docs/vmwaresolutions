...
* On the **Resources** page, the **ESXi servers** column in the instance summary tables is replaced by the **Version** column, in which you can find the release version that instances were deployed in or updated to.
