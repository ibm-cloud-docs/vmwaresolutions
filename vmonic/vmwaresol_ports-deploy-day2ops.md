...
| IBM CloudBuilder \n IBM CloudDriver | Private primary subnet \n Infrastructure VMs | {{site.data.keyword.cloud_notm}} Service - RabbitMQ \n {{site.data.keyword.cloud_notm}} Service - Log Analysis[^vssreqb] | {{site.data.keyword.cloud_notm}} endpoint service network | 443, 32378 | TCP | Use {{site.data.keyword.cloud_notm}} RabbitMQ and Log Analysis services | |
