...
To sign up for an {{site.data.keyword.cloud_notm}} infrastructure account, upgrade your {{site.data.keyword.cloud_notm}} account to the Pay-As-You-Go type of account. For more information, see [How do I upgrade or change my account type?](/docs/account?topic=account-accountfaqs)
