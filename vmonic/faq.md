...
If the status of the {{site.data.keyword.vcf-auto-short}} instance is **Available**, you can rename the cluster from the VMware vSphere® Web Client. For more information, see [How to rename VMware resources for instances V1.9 and later?](/docs/vmwaresolutions?topic=vmwaresolutions-vcenter_chg_impact#vcenter_chg_impact-vmware-resources-for-inst-v1.9-and-later)
