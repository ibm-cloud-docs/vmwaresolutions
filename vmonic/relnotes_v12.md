...
* [Troubleshooting for accessing Bluemix](/docs/account?topic=account-accessing){:external}
...
* [Zerto disaster recovery](/docs/services/vmwaresolutions?topic=vmware-solutions-addingzertodr)
...
For more information, see [User account and settings](/docs/services/vmwaresolutions?topic=vmware-solutions-useraccount).
