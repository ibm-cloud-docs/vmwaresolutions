...
For more information, see the following topics:
* [Considerations for F5 on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions?topic=vmware-solutions-f5_considerations)
* [Managing F5 on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions?topic=vmware-solutions-managing_f5)
...
For more information, see [Requesting managed services from IMI](/docs/services/vmwaresolutions?topic=vmware-solutions-managing_imi#requesting-managed-services-from-imi).
...
To enhance the scale out of your hosted VMware environment, you can now create a new cluster in a different {{site.data.keyword.cloud_notm}} Infrastructure (SoftLayer) pod, or a different {{site.data.keyword.CloudDataCent_notm}} than the initial cluster deployed in the instance.
...
For more information, see [Impacts of changing components for vCenter Server instances](/docs/services/vmwaresolutions?topic=vmware-solutions-vcenter_chg_impact).
...
* More documentation is provided for configuring firewalls that permit all protocol communication from the IBM CloudDriver and the SDDC Manager virtual machines. For more information, see [Components and considerations for Fortinet on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions?topic=vmware-solutions-fsa_considerations).
