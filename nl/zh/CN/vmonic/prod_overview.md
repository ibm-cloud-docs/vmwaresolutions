...
有关更多信息，请参阅 [vCenter Server with Hybridity Bundle 概述](/docs/services/vmwaresolutions/vcenter/vc_hybrid_overview.html)。
...
有关更多信息，请参阅 [VMware vSphere on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/vsphere/vs_vsphereclusteroverview.html)。

### NetApp ONTAP Select

NetApp ONTAP Select 产品支持部署软件定义的存储器集群，以满足您对基于 NetApp ONTAP Select 的专用和高可用性存储设备的需求。

有关更多信息，请参阅 [NetApp ONTAP Select 概述](/docs/services/vmwaresolutions/netapp/np_netappoverview.html)。
...
有关更多信息，请参阅 [VMware Federal on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/vcenter/vc_fed_overview.html)。
...
有关更多信息，请参阅 [F5 on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/f5_considerations.html)。
...
有关更多信息，请参阅 [FortiGate Security Appliance on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/fsa_considerations.html)。
...
有关更多信息，请参阅 [FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/fortinetvm_considerations.html)。
...
有关更多信息，请参阅 [HyTrust CloudControl on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/htcc_considerations.html)。
...
有关更多信息，请参阅 [HyTrust DataControl on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/htdc_considerations.html)。
...
有关更多信息，请参阅 [HyTrust KeyControl on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/htkc_considerations.html)。
...
有关更多信息，请参阅 [{{site.data.keyword.cloud_notm}} Private Hosted 概述](/docs/services/vmwaresolutions/services/icp_overview.html)。
...
有关更多信息，请参阅 [IBM Spectrum Protect Plus on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/spp_considerations.html)。
...
有关更多信息，请参阅 [Veeam on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/veeam_considerations.html)。
...
有关更多信息，请参阅 [VMware HCX on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/hcx_considerations.html)。
