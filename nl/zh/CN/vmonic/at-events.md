...
{{site.data.keyword.cloudaccesstrailfull_notm}} 服务将记录用户启动的会更改 {{site.data.keyword.Bluemix_notm}} 中服务状态的活动。有关更多信息，请参阅 [{{site.data.keyword.cloudaccesstrailshort}}](/docs/services/cloud-activity-tracker/index.html#getting-started-with-cla)。

## {{site.data.keyword.cloudaccesstrailshort}} 事件表
...
有关更多信息，请参阅 [Activity Tracker 事件字段](/docs/services/cloud-activity-tracker/at_event.html)。
...
* [供应 Activity Tracker](/docs/services/cloud-activity-tracker/how-to/provision.html)
* [在 {{site.data.keyword.cloud_notm}} 控制台中浏览至 Activity Tracker 仪表板](/docs/services/cloud-activity-tracker/how-to/manage-events-ui/launch_at_ui.html)
* [KMIP for VMware on {{site.data.keyword.cloud_notm}} 概述](/docs/services/vmwaresolutions/services/kmip_standalone_considerations.html)
