...
部署后，请转至 {{site.data.keyword.vmwaresolutions_short}} 控制台以使用保存的配置来扩展新集群。有关更多信息，请参阅[扩展现有 vSphere 集群](/docs/services/vmwaresolutions/vsphere?topic=vmware-solutions-vs_scalingexistingclusters)。
