...
* 在 {{site.data.keyword.cloud_notm}}“目录”中，选择 **HyTrust CloudControl on IBM Cloud**，指定服务设置，然后选择**添加到新实例**。
...
* 在 {{site.data.keyword.cloud_notm}}“目录”中，选择 **HyTrust CloudControl on IBM Cloud**，指定服务设置，然后选择**添加到现有实例**。
