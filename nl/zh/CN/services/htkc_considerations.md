...
此服务仅可用于运行 vSphere 6.5 以及部署在或已升级到 V2.5 和更高版本的实例。当前安装的 HyTrust KeyControl 版本为 4.2。
{:note}
...
* [订购 HyTrust KeyControl on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions/services/htkc_ordering.html)
