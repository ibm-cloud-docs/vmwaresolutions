...
## VMware vSphere on IBM Cloud 的组件
...
一个 IBM Cloud 裸机服务器，其硬件配置在 [VMware vSphere on IBM Cloud 的组件](../vsphere/vs_vsphereclusteroverview.html#components-of-vmware-vsphere-on-ibm-cloud)中提供。

### 扩展节点的联网

一个 IBM Cloud 裸机服务器，其联网配置在 [VMware vSphere on IBM Cloud 的组件](../vsphere/vs_vsphereclusteroverview.html#components-of-vmware-vsphere-on-ibm-cloud)中提供。
