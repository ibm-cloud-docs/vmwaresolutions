...
# 删除 Cloud Foundation 实例
{: #sd_deletinginstance}

要释放在 VMware Cloud Foundation 实例中订购的组件，请删除该实例。
...
2. 在 **Cloud Foundation 实例**表中，找到要删除的实例。
3. 在**操作**列中，单击“删除”图标。
...
* [删除多站点配置中的 Cloud Foundation 实例](/docs/services/vmwaresolutions/sddc?topic=vmware-solutions-sd_deletinginstance_multi)
...
* [删除多站点配置](/docs/services/vmwaresolutions/sddc?topic=vmware-solutions-sd_deletinginstance_multi)
