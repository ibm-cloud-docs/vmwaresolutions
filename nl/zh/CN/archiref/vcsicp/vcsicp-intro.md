...
* _vCenter Server 和 IBM Cloud Private_ - 当前指南，这是部署以下平台的参考体系结构：
...
* [vCenter Server 联网](../vcsnsxt/vcsnsxt-intro.html) - 此指南重点关注 vCenter Server、ICP 和 IKS 内使用的网络技术，例如 NSX-V、NSX-T 和 Calico。
