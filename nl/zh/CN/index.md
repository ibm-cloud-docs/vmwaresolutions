...
您需要 {{site.data.keyword.cloud_notm}} 帐户和 {{site.data.keyword.cloud_notm}} 基础架构 (SoftLayer) 帐户。 这些帐户必须满足某些需求。
   ...
   <tr>
      ...
      <td>{{site.data.keyword.cloud_notm}} Infrastructure (SoftLayer) 帐户先前称为 IBM SoftLayer 帐户。有关帐户必须满足的需求的更多信息，请参阅 [{{site.data.keyword.cloud_notm}} 基础架构帐户的需求](/docs/services/vmwaresolutions/vmonic/slaccountrequirement.html)。<br><br>您可以将 {{site.data.keyword.cloud_notm}} Infrastructure (SoftLayer) 帐户与 {{site.data.keyword.cloud_notm}} 帐户相链接，以使用组合基础架构即服务 (IaaS) 和平台即服务 (PaaS) 资源。然后，可以通过一次登录来访问 IaaS 资源和 PaaS 资源。链接帐户以后，还会将您使用的所有 PaaS 和 IaaS 资源的费用都开具在一张发票中。<ul><li>如果您没有 {{site.data.keyword.cloud_notm}} Infrastructure (SoftLayer) 帐户，请遵循[注册 IBM Cloud Infrastructure (SoftLayer) 帐户](/docs/services/vmwaresolutions/vmonic/signing_softlayer_account.html)中的过程请求 Infrastructure (SoftLayer) 帐户，然后遵循[链接 IBM 标识帐户](https://console.cloud.ibm.com/docs/account/softlayerlink.html)中的指示信息将 {{site.data.keyword.cloud_notm}} Infrastructure (SoftLayer) 帐户与 {{site.data.keyword.cloud_notm}} 帐户相链接。</li><li>如果您已有 {{site.data.keyword.cloud_notm}} Infrastructure (SoftLayer) 帐户，那么可以通过按[链接 IBM 标识帐户](https://console.cloud.ibm.com/docs/account/softlayerlink.html)中的过程操作将其与 {{site.data.keyword.cloud_notm}} 帐户相链接。</li></ul></td>
   </tr>
   </table>

有关更多信息，请参阅以下主题：
* [注册必需的帐户](/docs/services/vmwaresolutions/vmonic/signing_softlayer_account.html)
...
有关如何配置用户帐户和设置的信息，请参阅[管理用户帐户和设置](/docs/services/vmwaresolutions/vmonic/useraccount.html)。
