...
要查看 VMware Federal 实例中包含的联网组件，请参阅 [VMware Federal on IBM Cloud 的 vCenter Server 实例组件](vc_fed_overview.html#vcenter-server-instance-components-for-vmware-federal-on-ibm-cloud)。
