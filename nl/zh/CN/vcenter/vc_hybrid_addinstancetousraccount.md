...
在 {{site.data.keyword.cloud}} 帐户中 V2.5 和更高发行版中部署的 VMware vCenter Server with Hybridity Bundle 实例会自动添加到帐户，并由 {{site.data.keyword.cloud_notm}} Identity and Access Management (IAM) 进行管理。
