...
# 订购、查看和删除 Single-node Trial for Data Protection and Disaster Recovery 实例
{: #dr_backup_bundle_orderinginstance}

订购 Single-node Trial for Data Protection and Disaster Recovery 实例之前，请复查规划需求。

此试用版在 90 天后会自动删除。Single-node Trial for Data Protection and Disaster Recovery 实例的到期倒计时显示在实例详细信息页面上。
{:important}

## 订购 Single-node Trial for Data Protection and Disaster Recovery 实例的需求和规划
...
## 订购 Single-node Trial for Data Protection and Disaster Recovery 实例的过程
{: #dr_backup_bundle_orderinginstance-procedure}

1. 在 {{site.data.keyword.cloud_notm}}“目录”中，单击左侧导航窗格中的 **VMware** 图标，然后单击 **VMware 虚拟数据中心**部分中的 **Single-node Trial for Data Protection and Disaster Recovery** 卡。
2. 在 **Single-node Trial for Data Protection and Disaster Recovery** 页面上，单击**继续**。
...
### 订购 Single-node Trial for Data Protection and Disaster Recovery 实例之后的结果
...
* 成功部署实例后，[Single-node Trial for Data Protection and Disaster Recovery 实例的技术规范](/docs/services/vmwaresolutions/services?topic=vmware-solutions-dr_backup_bundle_overview#dr_backup_bundle_overview-tech-specs)中描述的组件已安装。
...
## 删除 Single-node Trial for Data Protection and Disaster Recovery 实例的过程
{: #dr_backup_bundle_orderinginstance-deleting-procedure}

删除 Single-node Trial for Data Protection and Disaster Recovery 实例时，会按顺序释放以下组件：
...
要删除 Single-node Trial for Data Protection and Disaster Recovery 实例，请完成以下步骤：
