...
# 订购、查看和删除 Data Protection and Disaster Recovery 单节点试用版实例
{: #dr_backup_bundle_orderinginstance}

订购 Data Protection and Disaster Recovery 单节点试用版实例之前，请复查规划需求。

此试用版在 90 天后会自动删除。Data Protection and Disaster Recovery 单节点试用版实例的到期倒计时显示在实例详细信息页面上。
{:important}

## 订购 Data Protection and Disaster Recovery 单节点试用版实例的需求和规划
...
### 订购 Data Protection and Disaster Recovery 单节点试用版实例之后的结果
...
## 删除 Data Protection and Disaster Recovery 单节点试用版实例的过程
{: #dr_backup_bundle_orderinginstance-deleting-procedure}

删除 Data Protection and Disaster Recovery 单节点试用版实例时，会按顺序释放以下组件：
...
要删除 Data Protection and Disaster Recovery 单节点试用版实例，请完成以下步骤：
