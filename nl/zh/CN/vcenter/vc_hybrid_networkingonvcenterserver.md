...
要查看 vCenter Server with Hybridity Bundle 实例中包含的联网组件，请参阅 [vCenter Server with Hybridity Bundle 概述](vc_hybrid_overview.html)中的 _vCenter Server with Hybridity Bundle 技术规范_部分。
...
* [VMware HCX on IBM Cloud 概述](../services/hcx_considerations.html)
