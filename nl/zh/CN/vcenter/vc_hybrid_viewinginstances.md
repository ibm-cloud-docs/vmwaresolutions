...
查看订购的 VMware vCenter Server with Hybridity Bundle 实例以及有关这些实例的详细信息。

## 查看 vCenter Server with Hybridity Bundle 实例摘要

要查看环境中所有 vCenter Server with Hybridity Bundle 实例的摘要，请完成以下步骤：
1. 在 {{site.data.keyword.vmwaresolutions_short}} 控制台中，单击左侧导航窗格中的**部署的实例**。
2. 在 **vCenter Server** 表中，查看实例的列表。
...
## 查看 vCenter Server with Hybridity Bundle 实例属性详细信息

要查看 vCenter Server with Hybridity Bundle 实例的属性详细信息，请执行以下操作：
1. 在 **vCenter Server 实例**表上，单击实例名称。
2. 在**属性**下，查看实例的详细信息。
...
## 查看 vCenter Server with Hybridity Bundle 实例的访问信息
...
## 查看 vCenter Server with Hybridity Bundle 实例的部署历史记录
