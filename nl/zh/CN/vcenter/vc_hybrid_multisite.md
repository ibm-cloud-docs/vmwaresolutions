...
![vCenter Server with Hybridity Bundle 多站点部署](../sddc/multisite-hub-spoke.svg "vCenter Server with Hybridity Bundle 多站点部署")
...
删除属于多站点配置的 vCenter Server with Hybridity Bundle 实例需要特殊规划。有关更多信息，请参阅[删除多站点配置中的 vCenter Server with Hybridity Bundle 实例](/docs/services/vmwaresolutions/vcenter/vc_hybrid_deletinginstance_multi.html)。
{:note}
