...
# 删除 vCenter Server with NSX-T 实例
{: #vc_nsx-t_deletinginstance}

要释放在 VMware vCenter Server with NSX-T 实例中订购的组件，请删除该实例。

删除 vCenter Server with NSX-T 实例时，会按顺序释放以下组件：
2. 支持费用
3. VMware 产品许可证
4. ESXi 服务器
5. 子网
...
* [删除多站点配置中的 vCenter Server 实例](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_deletinginstance_multi)
