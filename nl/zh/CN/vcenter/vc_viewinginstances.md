...
查看订购的 VMware vCenter Server 实例以及有关这些实例的详细信息。

## 查看 vCenter Server 实例摘要

要查看环境中所有 vCenter Server 实例的摘要，请完成以下步骤：
