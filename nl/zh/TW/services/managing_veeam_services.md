...
「IBM Resiliency Backup 即服務」提供適用範圍的強大站上、離站及混合式雲端型資料保護解決方案，以支援資訊備援。如需相關資訊，請參閱 [IBM Resiliency Backup 即服務](https://www.ibm.com/us-en/marketplace/managed-backup-services){:external}。

當您要求 Veeam on {{site.data.keyword.cloud_notm}} 的受管理服務時，請使用 Veeam 備份軟體及「IBM Resiliency Backup 即服務」來部署完全受管理備份環境。此組合透過下列方式協助您：
...
## 要求 Managed Services for Veeam on IBM Cloud 的程序
{: #managing_veeam_services-procedure}

1. 從 {{site.data.keyword.vmwaresolutions_short}} 主控台，按一下左導覽窗格中的**開始使用**。
2. 向下捲動頁面，然後按一下 **VMware 受管理服務**下的 **Managed Services for Veeam on IBM Cloud** 卡。
...
* [資料備份及保護服務](https://www.ibm.com/services/business-continuity/backup-data-protection){:external}
