...
* 從 {{site.data.keyword.cloud_notm}} 型錄中，選取 **HyTrust DataControl on IBM Cloud**，指定服務設定，然後選取**新增至新實例**。
...
* 從 {{site.data.keyword.cloud_notm}} 型錄中，選取 **HyTrust DataControl on IBM Cloud**，指定服務設定，然後選取**新增至現有實例**。
