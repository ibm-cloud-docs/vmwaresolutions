...
IMI 可以作為單一信任的提供者，以減少監視及管理虛擬 IT 基礎架構的複雜性，方法是提供 VMware vCenter Server 環境的「單一管理畫面 (single-pane-of-glass)」受管理服務。

IMI 提供 vCenter Server 實例的受管理服務。這些受管理服務包括進階 VMware vSphere 管理、完整 VMware NSX 涵蓋範圍以確保高可用性及安全虛擬網路基礎架構，以及 VMware vSAN 監視以確保資料可用性。
