...
現行安裝的 IBM Cloud Private 版本為 3.1.2。{{site.data.keyword.cloud_notm}} Automation Manager 也會部署為 {{site.data.keyword.cloud}} Private Hosted 服務訂購的一部分。
{:note}
...
{: caption="表 1.「正式作業就緒」和「開發/測試」環境的最低需求" caption-side="top"}

### IBM Cloud Private Hosted 的資源需求
{: #icp_overview-resource-req}

下表列出「正式作業就緒」環境中 {{site.data.keyword.cloud_notm}} Private Hosted 服務的資源需求。
...
| 記載的限制 | 52 | 640 |  | 8,000 |   |
{: caption="表 2. 正式作業就緒環境" caption-side="top"}

下表列出「開發」和「測試」環境中 {{site.data.keyword.cloud_notm}} Private Hosted 服務的資源需求。
...
|NSX Edge Services Gateway|2 |1 | 0.5 | 0.5 |2 |
| 記載的限制 | 30 | 200 |  | 4,000 |  |
{: caption="表 3. {{site.data.keyword.cloud_notm}} 開發和測試環境" caption-side="top"}
...
{: caption="表 4. 公式 1 中的變數說明" caption-side="top"}
...
{: caption="表 5. 公式 2 中的變數說明" caption-side="top"}
...
* [{{site.data.keyword.cloud_notm}} Automation Manager 授權](https://www.ibm.com/support/knowledgecenter/en/SS2L37_3.1.2.0/licensing.html){:external}
* [{{site.data.keyword.cloud_notm}} Automation Manager 元件](https://www.ibm.com/support/knowledgecenter/en/SS2L37_3.1.2.0/cam_managed_components.html){:external}
