...
您可以在訂購包含服務的新實例時，同時訂購 KMIP for VMware on {{site.data.keyword.cloud_notm}} 服務，或將服務新增至現有實例。

## 為新實例訂購 KMIP for VMware on IBM Cloud

您可以使用下列其中一種方法，訂購包含 KMIP for VMware on {{site.data.keyword.cloud_notm}} 的新實例：
* 當您從 {{site.data.keyword.vmwaresolutions_full}} 主控台訂購新實例時，請選取**服務**區段中的 **KMIP for VMware on IBM Cloud**。
* 從 {{site.data.keyword.cloud_notm}} 型錄中，選取 **KMIP for VMware on {{site.data.keyword.cloud_notm}} 服務**，指定服務設定，然後選取**新增至新實例**。
...
* 從 {{site.data.keyword.cloud_notm}} 型錄中，選取 **KMIP for VMware on IBM Cloud 服務**，指定服務設定，然後選取**新增至現有實例**。
...
表 1：KMIP for VMware on IBM Cloud 服務端點地區
...
* [KMIP for VMware on IBM Cloud 概觀](kmip_considerations.html)
