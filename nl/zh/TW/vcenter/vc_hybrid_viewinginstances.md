...
|建立時間|建立實例的日期和時間|  
|狀態|實例的狀態|
{: caption="表 1. vCenter Server with Hybridity Bundle 實例項目" caption-side="top"}
...
|刪除錯誤|刪除實例時發生錯誤。|
|已刪除|已刪除實例。|
{: caption="表 2. vCenter Server with Hybridity Bundle 實例狀態說明" caption-side="top"}
...
{: caption="表 3. vCenter Server with Hybridity Bundle 實例內容" caption-side="top"}
...
{: caption="表 4. 實例相關元件的 vCenter Server with Hybridity Bundle 存取資訊" caption-side="top"}
...
|日期 |變更實例狀態的日期和時間|
|摘要 |變更的詳細資料|
{: caption="表 5. vCenter Server with Hybridity Bundle 實例部署歷程" caption-side="top"}
