...
| 服務名稱                                                                               | 現行服務版本 | 實例版本 |
|----------------------------------------------------------------------------------------|------------------|
| [F5 on {{site.data.keyword.cloud_notm}}](../services/f5_considerations.html)                                 | BIG-IP VE 13.1.1.2 版 | 1.9 版以及更新版本 |
...
| [{{site.data.keyword.cloud_notm}} Private Hosted](../services/icp_overview.html) | 3.1 | 2.7 版以及更新版本 |
