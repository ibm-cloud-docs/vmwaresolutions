...
|製造商       |元件                            |版本|
|:------------- |:------------------------------ |:------------- |
|VMware       |vSphere ESXi                    |6.5 Update P3（建置 6.5.0-10884925）|
|VMware       |vCenter Server Appliance        |6.5 U2d（建置 6.5.0-10964411）|
|VMware       |Platform Services Controller    |6.5 U2d（建置 6.5.0-10964411）|
|VMware       |vSAN                            |6.6.1        |
