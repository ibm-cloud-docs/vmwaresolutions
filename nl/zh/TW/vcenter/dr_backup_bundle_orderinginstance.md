...
1. 在 {{site.data.keyword.cloud_notm}}「型錄」中，按一下左側導覽窗格中的 **VMware**，然後按一下**虛擬資料中心**區段中的 **Data Protection and Disaster Recovery 單一節點試用版**。
...
* 順利部署實例後，就會安裝[Data Protection and Disaster Recovery 單一節點試用版實例的技術規格](https://test.cloud.ibm.com/docs/services/vmwaresolutions/services?topic=vmware-solutions-dr_backup_bundle_overview#dr_backup_bundle_overview-tech-specs)中說明的元件。
