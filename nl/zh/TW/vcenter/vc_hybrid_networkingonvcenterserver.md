...
若要檢閱 vCenter Server with Hybridity Bundle 實例中所含的網路元件，請參閱 [vCenter Server with Hybridity Bundle 概觀](vc_hybrid_overview.html)中的 _vCenter Server with Hybridity Bundle 技術規格_ 小節。
...
* [VMware HCX on IBM Cloud 概觀](../services/hcx_considerations.html)
