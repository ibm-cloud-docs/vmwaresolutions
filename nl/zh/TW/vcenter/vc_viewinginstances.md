...
檢視您已訂購的 VMware vCenter Server 實例，以及其相關的詳細資訊。

## 檢視 vCenter Server 實例摘要

若要檢視環境中所有 vCenter Server 實例的摘要，請完成下列步驟：
