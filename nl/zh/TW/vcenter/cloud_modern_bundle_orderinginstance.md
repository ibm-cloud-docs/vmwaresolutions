...
* 順利部署實例後，就會安裝[Migration and App Modernization 單一節點試用版實例的技術規格](/docs/services/vmwaresolutions/services?topic=vmware-solutions-cloud_modern_bundle_overview#cloud_modern_bundle_overview-tech-specs)中說明的元件。
