...
* Discovery Service - 系統使用 Watson Discovery Service 來擷取符合所要求參數的「滑板運動記錄」。範例可能是「列出 Casper 技巧的所有記錄」。Watson Assistant - 系統使用 Watson Discovery Service 來擷取符合所要求參數的滑板運動相關內容。範例可能是「列出 Casper 技巧的所有記錄」。Watson Discovery 使用進階機器學習技術顯現來自所汲取內容的最相關通道。  
