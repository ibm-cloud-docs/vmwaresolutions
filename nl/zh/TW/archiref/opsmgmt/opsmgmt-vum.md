...
如需 VMware Update Manager 的詳細設計，請參閱 [VMware Update Manager 簡介](https://cloud.ibm.com/docs/services/vmwaresolutions/archiref/vum/vum-intro.html#vmware-update-manager-introduction){:new_window}。
