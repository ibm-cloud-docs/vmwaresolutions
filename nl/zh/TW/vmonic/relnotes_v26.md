...
如需相關資訊，請參閱下列主題：
* [HyTrust KeyControl on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions/services?topic=vmware-solutions-htkc_considerations) 的元件及考量
...
現行版本會將 VMware HCX 3.5.1 安裝至所有新部署的實例。如需 HCX 3.5.1 中新增特性的相關資訊，請參閱 [VMware HCX 文件](https://docs.vmware.com/en/VMware-HCX/index.html)。
