...
* [vCenter Server 技術規格](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_vcenterserveroverview)
...
如需相關資訊，請參閱[Cloud Foundation 實例的多站台配置](/docs/services/vmwaresolutions/sddc?topic=vmware-solutions-sd_multisite)。
...
如需相關資訊，請參閱 [Zerto 災難回復](/docs/services/vmwaresolutions/services?topic=vmware-solutions-addingzertodr)。
...
* 對於 Cloud Foundation 實例，您可以在實例詳細資料頁面上，檢視各種實例元件的使用者名稱及密碼。如需相關資訊，請參閱[檢視 Cloud Foundation 實例](/docs/services/vmwaresolutions/sddc?topic=vmware-solutions-sd_viewinginstances)。
* 對於 vCenter Server 實例，您現在可以直接從主控台安裝 IBM 元件的軟體更新及修補程式。如需相關資訊，請參閱[將更新及修補程式套用至 vCenter Server 實例](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_applyingupdates)。
