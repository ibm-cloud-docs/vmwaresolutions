...
當您在對 Cloud Foundation 和 vCenter Server 實例安裝 F5 on {{site.data.keyword.cloud_notm}} 服務時，您現在可以選取頻寬上限 10 Gbps。如需相關資訊，請參閱 [F5 on {{site.data.keyword.cloud_notm}}](../services/f5_considerations.html) 的考量。
