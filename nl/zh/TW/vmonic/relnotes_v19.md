...
如需相關資訊，請參閱下列主題：
* [F5 on {{site.data.keyword.cloud_notm}} 的考量](/docs/services/vmwaresolutions/services/f5_considerations.html)
...
如需相關資訊，請參閱[從 IMI 要求受管理服務](/docs/services/vmwaresolutions/services/managing_imi.html#requesting-managed-services-from-imi)。
...
如需相關資訊，請參閱[訂購 Cloud Foundation 實例](/docs/services/vmwaresolutions/sddc/sd_orderinginstance.html)。
...
如需相關資訊，請參閱[新增及檢視 vCenter Server 實例的叢集](/docs/services/vmwaresolutions/vcenter/vc_addingviewingclusters.html)。
...
如需相關資訊，請參閱[變更 vCenter Server 實例元件的影響](/docs/services/vmwaresolutions/vcenter/vcenter_chg_impact.html)。
...
* 提供其他文件來配置防火牆，以允許來自 IBM CloudDriver 和 SDDC Manager 虛擬機器的所有通訊協定通訊。如需相關資訊，請參閱 [Fortinet on {{site.data.keyword.cloud_notm}} 的元件及考量](/docs/services/vmwaresolutions/services/fsa_considerations.html)。
