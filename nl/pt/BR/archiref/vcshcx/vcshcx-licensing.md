...
- Uma chave de registro de uso descartável é fornecida para a instalação do
lado do cliente fornecida pelo console do {{site.data.keyword.vmwaresolutions_full}}. É necessária uma chave para
