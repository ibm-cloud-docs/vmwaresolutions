...
Depois que o serviço FortiGate Security Appliance no {{site.data.keyword.cloud_notm}} for instalado com êxito, será possível gerenciar e configurar regras de firewall para o FSA no console do FortiGate.

**Importante**: deve-se assegurar que as regras de firewall FSA sejam definidas para permitir que comunicações HTTPS (porta TCP 443) de saída que são iniciadas por componentes de gerenciamento, como a máquina virtual do IBM CloudDriver ou o Zerto Virtual Manager, sejam feitas com o banco de dados de gerenciamento externo na infraestrutura do IBM Cloud pela Internet. As comunicações HTTPS de saída (porta TCP 443) se originam do endereço IP público do VMware NSX Edge Services Gateway (ESG) dos serviços de gerenciamento em sua instância.

## Acessando o console série 300 do FortiGate

Para gerenciar o serviço FortiGate Security Appliance no {{site.data.keyword.cloud}}, deve-se acessar o console série 300 do FortiGate® de uma das maneiras a seguir:
