...
1. Três redes para o HCX da infraestrutura {{site.data.keyword.cloud_notm}} são pedidas:
...
2. Uma chave de ativação do HCX do VMware é pedida.
3. Três conjuntos de recursos e pastas de VM para o HCX, que são necessários para as interconexões do HCX, componentes do HCX local e componentes do HCX remoto, são criados.
