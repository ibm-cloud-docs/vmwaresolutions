...
É possível pedir o serviço F5 on {{site.data.keyword.cloud_notm}} ao pedir uma nova instância com o BIG-IP Virtual Edition (VE) incluído ou incluindo o BIG-IP VE em sua instância existente.
...
* No console do {{site.data.keyword.vmwaresolutions_full}}, quando você pedir uma nova instância, selecione **F5 on IBM Cloud** na seção **Serviços**.
* No catálogo do {{site.data.keyword.cloud_notm}}, selecione **Serviço F5 on {{site.data.keyword.cloud_notm}}**, especifique as configurações de serviço e selecione **Incluir nova instância**.
...
* No catálogo do {{site.data.keyword.cloud_notm}}, selecione o **serviço F5 on IBM Cloud**, especifique as configurações de serviço e selecione **Incluir em instância existente**.
