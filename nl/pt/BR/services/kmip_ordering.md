...
É possível pedir o serviço KMIP for VMware on {{site.data.keyword.cloud_notm}} ao pedir uma nova instância com o serviço incluído ou incluindo o serviço em sua instância existente.
...
* No console do {{site.data.keyword.vmwaresolutions_full}}, quando você pedir uma nova instância, selecione **KMIP for VMware on IBM Cloud** na seção **Serviços**.
* No catálogo do {{site.data.keyword.cloud_notm}}, selecione **Serviço KMIP for VMware on {{site.data.keyword.cloud_notm}}**, especifique as configurações de serviço e selecione **Incluir em nova instância**.
...
* No catálogo do {{site.data.keyword.cloud_notm}}, selecione **Serviço KMIP for VMware on IBM Cloud**, especifique as configurações de serviço e selecione **Incluir em instância existente**.
...
Tabela 1: KMIP para VMware nas regiões do terminal em serviço do IBM Cloud
...
* [Visão geral do KMIP for VMware on IBM Cloud](kmip_considerations.html)
