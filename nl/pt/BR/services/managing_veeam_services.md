...
# Serviços gerenciados para o Veeam on IBM Cloud
...
2. Role para baixo na página e, em **Serviços gerenciados do VMware**, clique no cartão **Serviços gerenciados para o Veeam on IBM Cloud**.
...
* [Serviços de backup e proteção de dados](https://www.ibm.com/services/business-continuity/backup-data-protection){:external}
