...
## Implementação multisite do vCenter Server with Hybridity Bundle
...
O gráfico a seguir descreve a visão geral da implementação multisite do vCenter Server with Hybridity Bundle.

Figura 1. Implementação multisite do vCenter Server with Hybridity Bundle

![Implementação multisite do vCenter Server with Hybridity Bundle](../sddc/multisite-hub-spoke.svg "Implementação multisite do vCenter Server with Hybridity Bundle")
