...
Visualize as instâncias do VMware vCenter Server with Hybridity Bundle que você pediu e informações detalhadas sobre elas.

## Visualizando o resumo de instâncias do vCenter Server with Hybridity Bundle

Para visualizar um resumo de todas as instâncias do vCenter Server with Hybridity Bundle em seu ambiente, conclua as etapas a seguir:
