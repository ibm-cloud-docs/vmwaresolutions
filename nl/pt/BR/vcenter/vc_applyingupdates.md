...
5. Para upgrades de licença NSX, clique em **Fazer upgrade da licença**. Selecione a edição da qual deseja fazer upgrade e clique em **Fazer upgrade**. Downgrades da edição da licença não estão disponíveis.
