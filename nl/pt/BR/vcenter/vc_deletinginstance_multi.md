...
Há considerações especiais que devem ser conhecidas antes de você planejar excluir instâncias do vCenter Server que fazem parte de uma configuração de vários sites.
