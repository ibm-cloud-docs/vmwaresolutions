...
1. No catálogo do {{site.data.keyword.cloud_notm}}, clique em **VMware** na área de janela de navegação esquerda e, em seguida, clique em **Single-node Trial for Data Protection and Disaster Recovery** na seção **Data centers virtuais**.
