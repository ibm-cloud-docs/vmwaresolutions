...
Para obter mais informações, veja [Visão geral do vCenter Server with Hybridity Bundle](/docs/services/vmwaresolutions/vcenter/vc_hybrid_overview.html).

### VMware Cloud Foundation on IBM Cloud

A oferta Cloud Foundation fornece um ambiente virtual VMware unificado usando recursos padrão de cálculo, armazenamento e rede do {{site.data.keyword.cloud_notm}} que são dedicados a cada implementação do usuário.
...
Para obter mais informações, consulte [Visão geral do VMware vSphere on {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions/vsphere/vs_vsphereclusteroverview.html).
...
Para obter mais informações, veja [Visão geral do NetApp ONTAP Select](/docs/services/vmwaresolutions/netapp/np_netappoverview.html).

### Federal do VMware on IBM Cloud

A oferta VMware Federal on {{site.data.keyword.cloud_notm}} fornece suporte para solicitar uma instância base do vCenter Server, além de fornecer a opção de proteger as instâncias implementadas, remover informações confidenciais e abrir a conexão de gerenciamento para acesso contínuo à instância para funções de gerenciamento.

Para obter mais informações, consulte [Visão geral do VMware Federal on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/vcenter/vc_fed_overview.html).
...
Para obter mais informações, consulte [Visão geral do F5 on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/f5_considerations.html).
...
Para obter mais informações, consulte [Visão geral do FortiGate Security Appliance on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/fsa_considerations.html).
...
Para obter mais informações, consulte [Visão geral do FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/fortinetvm_considerations.html).
...
Para obter mais informações, consulte [Visão geral do HyTrust CloudControl on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/htcc_considerations.html).
...
Para obter mais informações, consulte [Visão geral do HyTrust DataControl on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/htdc_considerations.html).
...
Para obter mais informações, consulte [Visão geral do HyTrust KeyControl on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/htkc_considerations.html).
...
Para obter mais informações, consulte [Visão geral do {{site.data.keyword.cloud_notm}} Private Hosted](/docs/services/vmwaresolutions/services/icp_overview.html).
...
Para obter mais informações, consulte [Visão geral do IBM Spectrum Protect Plus on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/spp_considerations.html).
...
Para obter mais informações, consulte [Visão geral do KMIP for VMware on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/kmip_standalone_considerations.html).
...
Para obter mais informações, consulte [Visão geral do Veeam on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/veeam_considerations.html).
...
Para obter mais informações, consulte [Visão geral do VMware HCX on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/hcx_considerations.html).
...
Para obter mais informações, consulte [Visão geral do Zerto on {{site.data.keyword.cloud_notm}} ](/docs/services/vmwaresolutions/services/addingzertodr.html).
