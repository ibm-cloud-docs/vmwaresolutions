...
**Nota:** esse recurso está disponível apenas para instâncias implementadas na V2.1 e mais recente. As instâncias submetidas a upgrade para a V2.1 por meio de liberações anteriores à V2.1 não têm essa opção.
