...
| 作成時間 | インスタンスが作成された日時 |  
| 状況 | インスタンスの状況 |
{: caption="表 1. vCenter Server with Hybridity Bundle インスタンスの項目" caption-side="top"}
...
| 削除済み | インスタンスは削除されました。 |
{: caption="表 2. vCenter Server with Hybridity Bundle インスタンスの状況の説明" caption-side="top"}
...
| DNS、SSO ドメイン | SSO ドメインは、vSphere のシングル・サインオン・ドメインです。 SSO ドメイン・ネームは、デプロイされたすべての vCenter Server with Hybridity Bundle インスタンスで <samp class="ph codeph">vsphere.local</samp> という値に固定されています。 |
| DNS、サブドメイン | サブドメインは、ローカル vCenter Server with Hybridity Bundle インスタンスのホスト名が存在するルート・ドメイン・ネームの DNS サブドメイン・ネームです。 サブドメイン名の形式は <samp class="ph codeph"><var class="keyword varname">vcenter_server_instance_name</var>.<var class="keyword varname">root.domain_name</var></samp> になります。 |
...
{: caption="表 3. vCenter Server with Hybridity Bundle インスタンスのプロパティー" caption-side="top"}
...
{: caption="表 4. インスタンス関連コンポーネントの vCenter Server with Hybridity Bundle アクセス情報" caption-side="top"}
...
| サマリー | 変更の詳細 |
{: caption="表 5. vCenter Server with Hybridity Bundle インスタンスのデプロイメント履歴" caption-side="top"}
