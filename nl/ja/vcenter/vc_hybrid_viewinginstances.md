...
## vCenter Server with Hybridity Bundle インスタンスのプロパティーの詳細の表示
...
表 3. vCenter Server with Hybridity Bundle インスタンスのプロパティー
...
## vCenter Server with Hybridity Bundle インスタンスのアクセス情報の表示
...
表 4. インスタンス関連コンポーネントの vCenter Server with Hybridity Bundle アクセス情報
