...
| 作成時間 | インスタンスが作成された日時 |
| 状況 | インスタンスの状況 |   
{: caption="表 1. vCenter Server インスタンスの項目" caption-side="top"}
...
| 削除済み | インスタンスは削除されました。 |
{: caption="表 2. vCenter Server インスタンスの状況の説明" caption-side="top"}
...
{: caption="表 4. インスタンス関連コンポーネントの vCenter Server アクセス情報" caption-side="top"}
...
| サマリー | 変更の詳細 |
{: caption="表 5. vCenter Server インスタンスのデプロイメント履歴" caption-side="top"}
