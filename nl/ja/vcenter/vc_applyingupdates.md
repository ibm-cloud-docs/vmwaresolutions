...
**重要:** vCenter Server インスタンスを vCenter Server with Hybridity Bundle インスタンスにアップグレードする場合は、まず少なくとも基本 vCenter Server V2.3 のソフトウェア更新を適用する必要があります。これを先に行ってから、Hybridity Bundle へのライセンス・アップグレードを実行する必要があります。
