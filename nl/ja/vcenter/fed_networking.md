...
VMware Federal インスタンスに含まれているネットワーキング・コンポーネントを確認するには、[VMware Federal on IBM Cloud の vCenter Server インスタンスのコンポーネント](vc_fed_overview.html#vcenter-server-instance-components-for-vmware-federal-on-ibm-cloud)を参照してください。
