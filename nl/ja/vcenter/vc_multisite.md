...
マルチサイト構成に含まれている vCenter Server インスタンスを削除するには、特別な計画が必要です。 詳しくは、[マルチサイト構成での vCenter Server インスタンスの削除](/docs/services/vmwaresolutions/vcenter/vc_deletinginstance_multi.html)を参照してください。
{:note}
