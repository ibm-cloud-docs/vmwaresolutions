...
# Single-node Trial for Data Protection and Disaster Recovery インスタンスの注文、表示、および削除
...
### Single-node Trial for Data Protection and Disaster Recovery インスタンスを注文した結果
...
## Single-node Trial for Data Protection and Disaster Recovery インスタンスを削除する手順
{: #dr_backup_bundle_orderinginstance-deleting-procedure}

Single-node Trial for Disaster Recover インスタンスを削除すると、以下のコンポーネントが順次解放されます。
...
Single-node Trial for Data Protection and Disaster Recovery インスタンスを削除するには、以下の手順を実行します。
