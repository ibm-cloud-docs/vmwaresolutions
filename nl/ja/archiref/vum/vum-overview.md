...
VUM は、マルチステージ・プロセスを使用して vSphere オブジェクトをアップグレードし、パッチまたは拡張を適用します。このプロセスにより、最小限のシステム・ダウン時間のスムーズな更新手順が可能になります。このプロセスを確認する前に、以下の用語を理解しておく必要があります。
