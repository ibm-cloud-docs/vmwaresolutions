...
分散論理ルーター (DLR)、論理スイッチ、ファイアウォールなどの必要な NSX コンポーネントは、管理者が構成できます。 ソリューションの一部としてデプロイされる NSX Edges について詳しくは、[vCenter Server ネットワーキング・ガイド](/docs/services/vmwaresolutions/archiref/vcsnsxt/vcsnsxt-intro.html)を参照してください。
