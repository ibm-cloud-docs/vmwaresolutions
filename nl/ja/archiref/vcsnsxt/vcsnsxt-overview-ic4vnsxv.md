...
![NSX-V Manager ネットワーク概要](../../images/vcsnsxt-vmgmt.svg "NSX-V Manager ネットワーク概要")
...
![Cluster VM kernel インターフェース・ポート・グループ・マッピング](../../images/vcsnsxt-vds-kernel-Int.svg "Cluster VM kernel インターフェース・ポート・グループ・マッピング")
