...
![Skate Advisor コンポーネント](../../images/vcscar-components.svg "Skate Advisor コンポーネント")
...
![代表的なチャットボット照会](../../images/vcscar-query.svg "代表的なチャットボット照会")
...
![Discovery Service トレーニング](../../images/vcscar-training.svg "Discovery Service トレーニング")
