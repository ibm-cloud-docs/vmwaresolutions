...
# Veeam on IBM Cloud 用マネージド・サービス
...
IBM Resiliency Backup as a Service は、オンサイト・クラウド、オフサイト・クラウド、ハイブリッド・クラウドを対象とした広範囲のデータ保護ソリューションを提供することによって、情報の回復力を高めます。 詳しくは、[IBM Resiliency Backup as a Service](https://www.ibm.com/us-en/marketplace/managed-backup-services){:external} を参照してください。
...
2. ページをスクロールダウンし、**「VMware マネージド・サービス」**で、**「Veeam on IBM Cloud のマネージド・サービス」**カードをクリックします。
...
6. このサービスを新規インスタンスの注文中に追加するには、**「新規インスタンスに追加」**をクリックしてから、新規 [vCenter Server](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_orderinginstance) インスタンスの注文を続けます。
