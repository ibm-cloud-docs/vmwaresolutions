...
* {{site.data.keyword.cloud_notm}} カタログから**「HyTrust DataControl on IBM Cloud」**を選択し、サービス設定を指定し、**「Add to New Instance」**を選択します。
...
* {{site.data.keyword.cloud_notm}} カタログから**「HyTrust DataControl on IBM Cloud」**を選択し、サービス設定を指定し、**「Add to Existing Instance」**を選択します。
