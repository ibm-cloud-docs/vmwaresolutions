...
マルチサイト構成の一部になっている Cloud Foundation インスタンスを削除するには、特別な計画が必要です。 詳しくは、[ マルチサイト構成での Cloud Foundation インスタンスの削除](/docs/services/vmwaresolutions/sddc/sd_deletinginstance_multi.html)を参照してください。
{:note}
