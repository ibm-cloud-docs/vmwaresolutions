...
現行リリースでは、新しくデプロイするすべてのインスタンスで、VMware HCX 3.5.1 がインストールされます。 HCX 3.5.1 の新機能について詳しくは、[VMware HCX 資料](https://docs.vmware.com/en/VMware-HCX/index.html)を参照してください。
