...
{{site.data.keyword.cloudaccesstrailfull_notm}} サービスは、{{site.data.keyword.cloud_notm}} 内のサービスの状態を変更するユーザー開始アクティビティーを記録します。 詳しくは、[IBM® Cloud Activity Tracker with LogDNA について](/docs/services/Activity-Tracker-with-LogDNA?topic=logdnaat-getting-started#gs_ov)を参照してください。
...
{: caption="表 1. Activity Tracker イベント・テーブルの説明" caption-side="top"}

詳しくは、[イベントのフィールド](/docs/services/Activity-Tracker-with-LogDNA?topic=logdnaat-event)を参照してください。
...
{: caption="表 2. 管理イベントを生成するアクションの説明" caption-side="top"}
...
{: caption="表 3. KMIP for VMware on {{site.data.keyword.cloud_notm}} サービスのイベントを生成するアクションの説明" caption-side="top"}
...
{{site.data.keyword.cloud_notm}} Activity Tracker with LogDNA を使用してインスタンスを表示します。詳しくは、[イベントの表示](/docs/services/Activity-Tracker-with-LogDNA?topic=logdnaat-view_events)を参照してください。
