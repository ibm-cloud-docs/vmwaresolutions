...
詳しくは、[vCenter Server with Hybridity Bundle の概要](../vcenter/vc_hybrid_overview.html)を参照してください。
...
詳しくは、[VMware vSphere on {{site.data.keyword.cloud_notm}} の概要](../vsphere/vs_vsphereclusteroverview.html)を参照してください。

### NetApp  ONTAP  Select

NetApp ONTAP Select オファリングでは、NetApp ONTAP Select をベースとする可用性の高い専用ストレージ・アプライアンスを必要とするニーズに対応するソフトウェア定義ストレージ・クラスターをデプロイできます。

詳しくは、[NetApp ONTAP Select の概要](../netapp/np_netappoverview.html)を参照してください。
...
詳しくは、[VMware Federal on {{site.data.keyword.cloud_notm}} の概要](../vcenter/vc_fed_overview.html)を参照してください。
...
詳しくは、[F5 on {{site.data.keyword.cloud_notm}} の概要](../services/f5_considerations.html)を参照してください。
...
詳しくは、[FortiGate Security Appliance on {{site.data.keyword.cloud_notm}} の概要](../services/fsa_considerations.html)を参照してください。
...
詳しくは、[FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}} の概要](../services/fortinetvm_considerations.html)を参照してください。
...
詳しくは、[HyTrust CloudControl on {{site.data.keyword.cloud_notm}} の概要](../services/htcc_considerations.html)を参照してください。
...
詳しくは、[{{site.data.keyword.cloud_notm}} Private Hosted の概要](../services/icp_overview.html)を参照してください。
...
詳しくは、[IBM Spectrum Protect Plus on {{site.data.keyword.cloud_notm}} の概要](../services/spp_considerations.html)を参照してください。
...
詳しくは、[KMIP for VMware on {{site.data.keyword.cloud_notm}} の概要](../services/kmip_considerations.html)を参照してください。
...
詳しくは、[VMware HCX on {{site.data.keyword.cloud_notm}} の概要](../services/hcx_considerations.html)を参照してください。
