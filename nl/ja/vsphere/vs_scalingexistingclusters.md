...
*  拡張対象のクラスターを使用する準備ができたことを示す確認メールを受け取る。
...
6. クラスターのパブリック VLAN 上に FortiGate 300 シリーズ Security Appliance の HA ペアが含まれていない場合は、そのアプライアンスを注文できます。これを行うには、**「FortiGate 物理アプライアンス 300 シリーズ HA ペア」**の舌の**「購入に含める」**チェック・ボックスを選択します。
