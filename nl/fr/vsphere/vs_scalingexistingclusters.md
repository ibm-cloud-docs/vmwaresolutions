...
*  Vous avez été averti par courrier électronique que le cluster que vous souhaitez mettre à échelle est prêt à être utilisé.
...
Si le cluster que vous mettez à l'échelle n'est pas prêt à être utilisé, il se peut qu'une erreur soit signalée par la procédure de mise à l'échelle de cluster existant. 
