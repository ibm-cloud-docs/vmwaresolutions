...
Cas d'utilisation de référence qui décrit la façon dont une application WebSphere Application Server classique est modernisée à l'aide d'{{site.data.keyword.cloud}} Private, de contenu IBM Middleware, d'{{site.data.keyword.cloud_notm}} Kubernetes Service et de VMware vCenter Server on {{site.data.keyword.cloud_notm}}.
