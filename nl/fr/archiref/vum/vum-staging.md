...
10.	Il n'y a aucune condition requise dans une instance vCenter Server pour sélectionner la case à cocher sous ESXi Patch Settings afin d'autoriser Update Manager à appliquer des correctifs sur des hôtes ESXi sous tension démarrés avec PXE.
11.	Cliquez sur **Next**.
