...
- Network Extension (HCX-NE) - Fournit les capacités d'extension réseau de couche 2, permettant des migrations entre l'emplacement sur site et l'environnement vSphere avec la nécessité de re-IP sur les machines virtuelles. 
