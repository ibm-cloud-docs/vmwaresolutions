...
2.	Le serveur de noms de domaine est utilisé pour déterminer l'adresse IP. Cette adresse IP sera une adresse publique {{site.data.keyword.cloud}} sur un sous-réseau portable qui a été affecté à l'instance VCS. 
