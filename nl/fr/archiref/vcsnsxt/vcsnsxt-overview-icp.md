...
La gestion de réseau ICP est facilitée par l'utilisation de Calico.
...
Pour plus d'informations sur la mise en réseau Calico, voir [IBM Kubernetes Service](vcsnsxt-overview-iks.html).
