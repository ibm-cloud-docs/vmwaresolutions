...
Vous pouvez ajouter le service FortiGate Security Appliance on {{site.data.keyword.cloud_notm}} dans une instance existante à l'aide de l'une des méthodes suivantes :
