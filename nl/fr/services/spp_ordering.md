...
Vous pouvez commander le service IBM Spectrum Protect Plus on {{site.data.keyword.cloud}} lors de la commande d'une nouvelle instance avec le service inclus ou vous pouvez ajouter le service à votre instance existante.
...
* Si vous voulez commander des licences pour IBM Spectrum Protect Plus, renseignez la zone **Nombre de machines virtuelles pour lesquelles concéder une licence** dans l'onglet **Commander des licences**. Un minimum de 10 machines virtuelles est requis pour la gestion des licences.
...
5. La machine virtuelle IBM Spectrum Protect Plus est déployée, activée et configurée dans le cluster par défaut de l'instance.
...
8. (Pour les instances V2.3 et ultérieures) Une tâche de sauvegarde de gestion par défaut est créée dans IBM Spectrum Protect Plus. Pour plus d'informations, voir [Gestion d'IBM Spectrum Protect Plus on IBM Cloud](managingspp.html).
