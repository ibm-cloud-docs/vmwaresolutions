...
Ce service est disponible uniquement sur les instances déployées en version 1.9 ou dans des éditions ultérieures. La version de BIG-IP VE qui est installée est la version 14.1.0.2.
{:note}
