...
Un minimum de 4 machines virtuelles est nécessaire pour la gestion des licences.

### Taille de stockage

Capacité répondant à vos besoins en matière de stockage. Un minimum de 2 000 Go d'espace de stockage est nécessaire pour la gestion. Pour toute question concernant l'estimation de la taille de l'espace de stockage, voir [Estimation de la capacité de référentiel](https://bp.veeam.expert/resource_planning/repository_planning_sizing.html).
