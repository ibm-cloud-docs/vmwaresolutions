...
Vous pouvez ajouter le service HyTrust DataControl on {{site.data.keyword.cloud_notm}} dans une instance existante à l'aide de l'une des méthodes suivantes :
