...
Ce service est disponible uniquement sur les instances déployées en version 1.8 ou dans des éditions ultérieures. La version actuelle de Veeam installée est la version 9.5u4b.
{:note}
