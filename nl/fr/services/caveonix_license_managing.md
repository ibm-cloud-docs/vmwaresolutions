...
Avant de supprimer la licence Caveonix RiskForesight, prenez soin de passer en revue les remarques décrites dans la rubrique [Remarques relatives à la suppression de licences Caveonix RiskForesight](/docs/services/vmwaresolutions/services?topic=vmware-solutions-caveonix_license_considerations-remove){:note}
...
4. Dans la fenêtre **Supprimer une licence**, cliquez sur **OK**. La licence prend le statut **Retrait en cours**. Lorsque la suppression de la licence est terminée, celle-ci n'est plus disponible dans le tableau **Licences Caveonix RiskForesight**.
