...
Ce service n'est disponible que pour les instances qui exécutent vSphere 6.5 et qui sont déployées dans ou mises à niveau vers la version 2.5 ou des éditions ultérieures. La version de HyTrust KeyControl qui est installée est la version 4.3.
{:note}
