...
# Services gérés pour Veeam on IBM Cloud
...
## Procédure de demande de Services gérés pour Veeam on IBM Cloud
...
2. Faites défiler la page vers le bas et sous **Services gérés VMware**, cliquez sur la carte **Services gérés pour Veeam on IBM Cloud**.
...
6. Pour ajouter le service pendant que vous commandez une nouvelle instance, cliquez sur **Ajouter à une nouvelle instance** et poursuivez votre commande d'instance [vCenter Server](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_orderinginstance).
...
* [Services de protection et de sauvegarde des données](https://www.ibm.com/services/business-continuity/backup-data-protection){:external}
