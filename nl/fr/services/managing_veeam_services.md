...
3. Sur la page **Services gérés pour Veeam on IBM Cloud**, passez en revue la description et les spécifications techniques concernant Veeam on {{site.data.keyword.cloud_notm}} en tant que service géré, puis cliquez sur **Créer**.
