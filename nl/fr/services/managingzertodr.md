...
La passerelle de gestion VMware NSX ESG (Edge Services Gateway) des instances Cloud Foundation et vCenter Server on {{site.data.keyword.cloud_notm}} est préconfigurée de manière à autoriser les communications HTTPS sortantes (port TCP 443) provenant de ZVM.
{:note}
