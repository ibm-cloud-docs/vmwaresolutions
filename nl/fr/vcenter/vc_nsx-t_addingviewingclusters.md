...
Lorsque vous ajoutez un cluster pour une instance vCenter Server with NSX-T, vous devez spécifier les paramètres suivants :
...
* Le nom de cluster doit être unique au sein de l'instance vCenter Server with NSX-T.
...
Vous pouvez choisir l'option **Skylake**, **Cascade** ou **Broadwell**.
...
### Que se passe-t-il après l'ajout de clusters à des instances vCenter Server with NSX-T ?
...
## Procédure d'affichage des clusters dans les instances vCenter Server with NSX-T
...
{: caption="Tableau 6. Détails relatifs au stockage" caption-side="top"}
...
### Procédure de suppression de clusters des instances vCenter Server with NSX-T
