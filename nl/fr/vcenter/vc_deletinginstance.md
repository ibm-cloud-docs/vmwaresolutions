...
## Procédure de suppression d'instances sur la page Instances déployées
...
* [Suppression d'instances vCenter Server dans une configuration multisite](/docs/services/vmwaresolutions/vcenter/vc_deletinginstance_multi.html)
