...
Pour passer en revue les composants de mise en réseau inclus dans votre instance vCenter Server, voir [Spécifications techniques relatives aux instances vCenter Server](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_vcenterserveroverview#specs).
