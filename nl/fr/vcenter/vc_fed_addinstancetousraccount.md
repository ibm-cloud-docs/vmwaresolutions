...
# Migration d'instances VMware Federal antérieures à la version 2.5 vers des comptes IBM Cloud

Les instances VMware Federal qui sont déployées dans la version 2.5 et dans des éditions ultérieures dans votre compte {{site.data.keyword.cloud}} sont ajoutées automatiquement à votre compte et sont gérées par {{site.data.keyword.cloud_notm}} Identity and Access Management (IAM).
...
## Avant de faire migrer des instances
...
## Résultats après la migration d'instances
