...
Pour passer en revue les composants de mise en réseau inclus dans votre instance vCenter Server with Hybridity Bundle, voir la section _Spécifications techniques de vCenter Server with Hybridity Bundle_ dans la rubrique [Présentation de vCenter Server with Hybridity Bundle](vc_hybrid_overview.html).
...
* [Présentation de VMware HCX on IBM Cloud](../services/hcx_considerations.html)
