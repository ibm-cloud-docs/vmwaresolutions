...
* [La passerelle NSX Edge des services de gestion présente-t-elle un risque pour la sécurité ?](/docs/services/vmwaresolutions/vmonic?topic=vmware-solutions-faq#faq-mgmt-nsx)
...
* Pour les instances Cloud Foundation et vCenter Server, vous pouvez afficher et passer en revue le coût estimé de vos serveurs ESXi avant de les ajouter à votre instance. Une fois que vous avez indiqué le nombre de serveurs que vous voulez ajouter, le coût estimé par serveur, par mois, s'affiche sur la console. Pour plus d'informations, voir [Extension et réduction de capacité pour des instances vCenter Server](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_addingremovingservers).
