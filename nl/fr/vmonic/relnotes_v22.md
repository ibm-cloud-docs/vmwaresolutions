...
Trente quatre unités SATA sont désormais disponibles pour les serveurs {{site.data.keyword.baremetal_short}} NetApp ONTAP Select à haute disponibilité. Pour plus d'informations, voir [Spécifications techniques relatives aux instances NetApp ONTAP Select](/docs/services/vmwaresolutions/netapp?topic=vmware-solutions-np_netappoverview#specs).
