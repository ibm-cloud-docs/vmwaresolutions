...
* Une documentation supplémentaire est fournie pour configurer les pare-feu qui permettent toutes les communications de protocole depuis IBM CloudDriver et les machines virtuelles du gestionnaire SDDC. Pour plus d'informations, voir [Composants et remarques pour Fortinet on {{site.data.keyword.cloud_notm}}](../services/fsa_considerations.html).
