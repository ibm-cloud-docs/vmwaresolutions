...
Pour obtenir un compte d'infrastructure {{site.data.keyword.cloud_notm}}, mettez à niveau votre compte {{site.data.keyword.cloud_notm}} à un compte facturable. Pour plus d'informations, voir [Comment mettre à niveau ou convertir mon type de compte ?](/docs/account?topic=account-accountfaqs#changeacct)

## Liens connexes
{: #signing_required_accounts￼-related}

* [Foire aux questions](/docs/services/vmwaresolutions/vmonic?topic=vmware-solutions-faq)
* [Exigences relatives au compte d'infrastructure {{site.data.keyword.cloud_notm}}](/docs/services/vmwaresolutions/vmonic?topic=vmware-solutions-cloud-infra-acct-req)
