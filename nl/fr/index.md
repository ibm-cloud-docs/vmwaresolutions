...
Pour plus d'informations sur la configuration de votre compte utilisateur et des paramètres, voir [Gestion des paramètres et comptes utilisateur](/docs/services/vmwaresolutions/vmonic/useraccount.html).
