...
3. Cree un clúster nuevo con los mismos valores que el clúster existente que se ha creado fuera de la consola de {{site.data.keyword.vmwaresolutions_short}}. Para obtener más información, consulte [Solicitud de clústeres nuevos de vSphere](vs_orderinginstances.html).  
...
7. Pulse el separador **Escalar clúster existente** y seleccione el clúster que acaba de crear en la lista **Configuraciones de clúster**.
