...
**Notas:**
* Si instala el servicio para instancias que se despliegan en V2.4 o releases posteriores, se instalará IBM Spectrum Protect Plus V10.1.1 Parche 1. El servicio proporciona soporte de recuperación para las máquinas virtuales (VM) de gestión automáticamente.
* Si instala el servicio para instancias que se despliegan en V2.3, se instalará IBM Spectrum Protect Plus V10.1.1. El servicio proporciona copias de seguridad automáticas para VM de gestión.
