...
4. Inicie sesión en la consola utilizando las credenciales de la consola que puede encontrar en la página de detalles del servicio HyTrust DataControl on {{site.data.keyword.cloud_notm}}, en la consola de {{site.data.keyword.vmwaresolutions_short}}.
