...
Estos pasos se aplican a la actualización de los valores de red HTCC en la máquina virtual primaria (VM), que se utiliza para las actualizaciones de licencias. No es necesario que actualice los valores para la máquina virtual secundaria.
{:note}
...
en el paso 3, y pulse **Guardar**. 
  ...
  Asegúrese de establecer la ruta estática antes de cambiar la pasarela predeterminada, de lo contrario, podría perderse la comunicación con la consola web.
  {:important}
