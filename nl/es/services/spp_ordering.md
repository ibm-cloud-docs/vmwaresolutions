...
Puede solicitar el servicio de IBM Spectrum Protect Plus on {{site.data.keyword.cloud}} al pedir una instancia nueva incluida con el servicio o añadiendo el servicio a la instancia existente.
...
* Si desea solicitar licencias para IBM Spectrum Protect Plus, especifique **Número de máquinas virtuales para licencia** en el separador **Pedido de licencias**. Se necesitan como mínimo 10 máquinas virtuales (VM) para la gestión de licencias.
...
8. (Para instancias de V2.3 y posterior) Se crea un trabajo de copia de seguridad de gestión predeterminada en IBM Spectrum Protect Plus. Para obtener más información, consulte [Gestión de IBM Spectrum Protect Plus on IBM Cloud](managingspp.html).
