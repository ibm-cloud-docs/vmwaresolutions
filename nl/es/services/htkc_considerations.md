...
Este servicio solo está disponible para las instancias que se ejecutan en vSphere 6.5 y que se han desplegado en, o que se han actualizado a, V2.5 o releases posteriores. La versión actual de HyTrust KeyControl que está instalada es la 4.3.2.
{:note}
