...
* Desde el catálogo de {{site.data.keyword.cloud_notm}}, seleccione **FortiGate Security Appliance on IBM Cloud**, especifique los valores de servicio y seleccione **Añadir a instancia nueva**.
...
* Desde el catálogo de {{site.data.keyword.cloud_notm}}, seleccione **FortiGate Security Appliance on IBM Cloud**, especifique los valores de servicio y seleccione **Añadir a instancia existente**.
