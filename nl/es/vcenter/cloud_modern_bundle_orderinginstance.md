...
1. En el catálogo de {{site.data.keyword.cloud_notm}}, pulse el icono **VMware** en el panel de navegación de la izquierda y, a continuación, pulse la tarjeta **Prueba de un solo nodo para la migración y modernización de apps** en la sección **Centros de datos virtuales de VMware**.
