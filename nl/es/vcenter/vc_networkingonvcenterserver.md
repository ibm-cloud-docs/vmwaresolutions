...
Revise la siguiente información para obtener detalles sobre las consideraciones y requisitos de red para las instancias de vCenter Server. Asegúrese de cumplir los requisitos para que la instancia funcione correctamente.

## Componentes de red para instancias de vCenter Server

Para revisar los componentes de red que se incluyen en la instancia de vCenter Server, consulte la sección _Especificaciones técnicas de vCenter Server_ en [Visión general de vCenter Server](vc_vcenterserveroverview.html).
