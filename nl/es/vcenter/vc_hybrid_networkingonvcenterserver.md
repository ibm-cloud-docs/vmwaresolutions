...
Para revisar los componentes de red que se incluyen en el vCenter Server con el paquete híbrido (Hybridity), consulte la sección _Especificaciones técnicas de vCenter Server con el paquete híbrido (Hybridity)_ en la [Visión general de vCenter Server con el paquete híbrido (Hybridity)](vc_hybrid_overview.html).
...
* [Visión general de VMware HCX on IBM Cloud](../services/hcx_considerations.html)
