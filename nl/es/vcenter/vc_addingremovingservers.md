...
5. En la sección **Servidores ESXi**, pulse **Añadir servidor**.
6. En la ventana **Añadir servidor**, escriba el número de servidores que desea añadir, revise el coste estimado y pulse **Añadir servidor**.
...
* El clúster de vCenter Server existente ya debe tener la opción de almacenamiento NFS y debe estar en estado **Listo para su uso**.
...
### Resultados después de añadir almacenamiento NSF
...
* El clúster de vCenter Server existente debe tener al menos una compartición de archivos NFS restante en el clúster.
...
1. Puede experimentar un ligero retardo en la consola, mientras el estado de instancia pasa de **Listo para su uso** a **Modificando**. Permita que la operación finalice por completo antes de realizar más cambios en la instancia.
2. Se le notificará por correo electrónico de que su solicitud para eliminar almacenamiento NSF se está procesando. En la consola, el estado del clúster asociado con el almacenamiento NFS se cambia a **Modificando**.
