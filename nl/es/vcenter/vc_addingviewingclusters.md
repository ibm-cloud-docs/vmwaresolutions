...
**Disponibilidad:** La característica de supresión de clústeres solo está disponible para las instancias que se despliegan en (o se actualizan a) V2.3 y posteriores.
...
* Para instancias que se han desplegado en V2.2 o anteriores, puede añadir hasta cinco clústeres.
...
Después del despliegue, puede crear un máximo de cuatro clústeres más. Si selecciona la configuración de servidor nativo **Personalizado** con el almacenamiento VMware vSAN, se necesitan cuatro servidores para el clúster inicial y los clústeres posteriores al despliegue.
