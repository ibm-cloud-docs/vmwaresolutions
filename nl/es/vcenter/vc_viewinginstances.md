...
{: caption="Tabla 1. Elementos de la instancia de vCenter Server" caption-side="top"}
...
{: caption="Tabla 2. Descripciones de los estados de las instancias de vCenter Server" caption-side="top"}
...
{: caption="Tabla 4. Información de acceso de vCenter Server correspondiente a los componentes relacionados con la instancia" caption-side="top"}
...
{: caption="Tabla 5. Historial de despliegues de la instancia de vCenter Server" caption-side="top"}
