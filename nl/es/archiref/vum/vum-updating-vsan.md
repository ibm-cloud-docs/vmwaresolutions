...
* **Actualizar el vCenter Server Appliance**. Para obtener más información, consulte [Actualización de VCSA y vCenters enlazados con SSO](vum-updating-vcsa.html).
* **Actualizar los hosts de vSphere ESXi**: para obtener más información, consulte la sección sobre Cómo crear líneas base y cómo adjuntarlas a objetos de inventario](vum-baselines.html).
...
5. Escriba `cd 1`, especifique y, a continuación, ` ls ` y pulse **Intr **. Verá lo siguiente: ` 0/datacenter1 (centro de datos) `
