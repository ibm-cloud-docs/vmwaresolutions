...
El servicio VMware HCX on IBM Cloud permite crear una conexión directa entre IBM Cloud for VMware Solutions y un centro de datos virtualizado local de VMware. 
...
* Deduplicación de datos: se puede conseguir una reducción del tráfico de red de hasta un 50 % 
