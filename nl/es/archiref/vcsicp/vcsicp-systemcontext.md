...
Terraform | Maneja el suministro de recursos de nube y de infraestructura mediante el uso de proveedores como VMware vSphere, IBM Cloud, Microsoft Azure, Amazon Web Services, Google Cloud Platform y OpenStack.
