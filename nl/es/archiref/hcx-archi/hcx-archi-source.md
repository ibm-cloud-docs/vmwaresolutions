...
### Número máximo de migración y extensión de red
...
Figura 2. Pasarela de nube de origen ![Pasarela de nube de origen](source_cloud_gateway.svg)
...
* [Instalación y configuración en el origen](hcx-archi-install-cfg-src.html)
