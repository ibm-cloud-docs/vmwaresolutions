...
La virtualización de red proporciona una superposición de red que existe dentro de la capa virtual. Proporciona la arquitectura con características tales como el aprovisionamiento rápido, el despliegue, la reconfiguración y la destrucción de las redes virtuales bajo demanda. Este diseño utiliza el conmutador distribuido de vSphere (vDS) y VMware NSX for vSphere para implementar la red virtual.
...
\* El grupo de puertos vSAN utiliza una migración tras error explícita con espera activa, ya que no se admite el equilibrio de carga del tráfico de almacenamiento de vSAN.
...
-	Solo para VCS, dispositivos NSX Edge Services Gateway (ESG) para uso del cliente.
...
En el siguiente diagrama se muestra cómo puede implementar algunas de las características de microsegmentación de NSX-V mediante la creación de grupos de seguridad. En este ejemplo, Prod y Dev son los grupos de seguridad y las reglas de seguridad se asignan en función de estos grupos.
