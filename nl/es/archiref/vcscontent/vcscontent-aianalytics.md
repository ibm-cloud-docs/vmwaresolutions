...
El ejemplo siguiente es una forma sencilla de perfeccionar una aplicación, pero resulta falsamente potente. Jane examina el [catálogo de {{site.data.keyword.cloud}}](https://cloud.ibm.com/catalog) en busca de servicios de [IA](https://cloud.ibm.com/catalog?category=ai) y de [Análisis](https://cloud.ibm.com/catalog?category=analytics) y encuentra mucho contenido en el catálogo.
