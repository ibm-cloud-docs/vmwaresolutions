...
{{site.data.keyword.vmwaresolutions_full}} le permite utilizar las habilidades, los conjuntos de herramientas y los runbooks existentes del equipo para gestionar las instancias en {{site.data.keyword.cloud_notm}}.

En la lista siguiente se incluyen los procedimientos, guías y tareas más comunes:
