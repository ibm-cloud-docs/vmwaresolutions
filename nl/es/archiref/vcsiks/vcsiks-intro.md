...
* [Redes de vCenter Server](../vcsnsxt/vcsnsxt-intro.html): se centra en las tecnologías de red que se utilizan en vCenter Server, {{site.data.keyword.icpfull_notm}} e {{site.data.keyword.containerlong_notm}}, como NSX-V, NSX-T y Calico.
