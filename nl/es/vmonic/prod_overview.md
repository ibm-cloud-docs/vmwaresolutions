...
Para obtener más información, consulte [Visión general de vCenter Server con el paquete híbrido (Hybridity)](../vcenter/vc_hybrid_overview.html).
...
Para obtener más información, consulte [Visión general de VMware vSphere on {{site.data.keyword.cloud_notm}}](../vsphere/vs_vsphereclusteroverview.html).
...
Para obtener más información, consulte [Visión general de NetApp ONTAP Select](../netapp/np_netappoverview.html).

### VMware Federal on IBM Cloud

La oferta VMware Federal on {{site.data.keyword.cloud_notm}} ofrece soporte para solicitar una instancia de base vCenter Server además de ofrecer la opción de proteger las instancias desplegadas eliminando la información confidencial y la conexión de gestión abierta para el acceso continuado a la instancia para las funciones de gestión.

Para obtener más información, consulte [Visión general de VMware Federal on {{site.data.keyword.cloud_notm}}](../vcenter/vc_fed_overview.html).
...
Para obtener más información, consulte [Visión general de F5 on {{site.data.keyword.cloud_notm}}](../services/f5_considerations.html).
...
Para obtener más información, consulte [Visión general de FortiGate Security Appliance on {{site.data.keyword.cloud_notm}}](../services/fsa_considerations.html).
...
Para obtener más información, consulte [Visión general de FortiGate Virtual Appliance on {{site.data.keyword.cloud_notm}}](../services/fortinetvm_considerations.html).
...
Para obtener más información, consulte [Visión general de HyTrust CloudControl on {{site.data.keyword.cloud_notm}}](../services/htcc_considerations.html).
...
Para obtener más información, consulte [{{site.data.keyword.cloud_notm}} Private Hosted](../services/managing_icp.html).
...
Para obtener más información, consulte [Visión general de IBM Spectrum Protect Plus on {{site.data.keyword.cloud_notm}}](../services/spp_considerations.html).
...
Para obtener más información, consulte [Visión general de KMIP for VMware on {{site.data.keyword.cloud_notm}}](../services/kmip_considerations.html).
...
Para obtener más información, consulte [Visión general de VMware HCX on {{site.data.keyword.cloud_notm}}](../services/hcx_considerations.html).
