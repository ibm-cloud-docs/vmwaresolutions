...
1. **홈** > **호스트 및 클러스터**로 이동하여 탐색 분할창에서 **vSAN 클러스터**를 선택한 후 **구성** 탭을 선택하고 **vSAN**으로 이동한 후 **일반**으로 이동하십시오. **인터넷 연결** 섹션으로 스크롤하여 **편집**을 클릭하십시오.
...
7. **Update Manager**탭을 클릭하면 vSAN 클러스터가 기준선에 추가됩니다.
...
* **모든 vSAN 디스크가 정상이어야 합니다.**
  - 장애가 있거나 존재하지 않는 디스크가 없습니다. vSphere Web Client에서 **vSAN 디스크 관리** 보기를 통해 이를 판별할 수 있습니다. **홈** > **호스트 및 클러스터**를 선택한 후 **vSAN 클러스터**를 선택하고 **vSAN** 탭을 클릭한 후 **실제 디스크**를 클릭하십시오. 모든 디스크를 스크롤하여 vSAN 상태를 검토하십시오.
