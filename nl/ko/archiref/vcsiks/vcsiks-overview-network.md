...
[클러스터 및 작업자 노드 설정 계획](/docs/containers?topic=containers-plan_clusters#plan_clusters)은 요구사항을 충족하는 솔루션을 설계하기 위한 옵션과 프로세스에 대해 설명합니다.
