...
# vCenter Server 및 IBM Kubernetes 서비스 소개
...
* [vCenter Server 및 {{site.data.keyword.cloud_notm}} Private](../vcsiks/vcsiks-intro.html) - 다음 플랫폼을 배치하기 위한 참조 아키텍처입니다.
  - **VMware vCenter Server on {{site.data.keyword.cloud_notm}}** - {{site.data.keyword.vmwaresolutions_full}}의 오퍼링이며 {{site.data.keyword.cloud_notm}}에서 자동으로 프로비저닝되는 VMware 기반 플랫폼입니다.
...
* [vCenter Server 네트워킹](../vcsnsxt/vcsnsxt-intro.html) - NSX-V, NSX-T 및 Calico 등 VCS, ICP 및 IKS 내에서 사용되는 네트워크 기술을 설명합니다.
