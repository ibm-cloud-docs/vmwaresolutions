...
온클라우드 VM | 온클라우드 VM은 온프레미스에서 마이그레이션된 애플리케이션을 호스팅합니다. 이는 스트레칭된 L2 네트워크를 통해 온프레미스 애플리케이션과 통신합니다. 이 참조 아키텍처 및 Acme Skateboards 예의 경우, 온클라우드 VM 중 하나는 온라인 상태 워크로드의 일부인 데이터베이스 서버입니다.
