...
|내부 |내부 |워크로드 HA VXLAN | ESG HA 쌍 하트비트에 사용되는 내부 인터페이스, **SDDC-Dswitch-Private**의 포트 그룹 |
...
워크로드 토폴로지 ESG 및 DLR HA 쌍에는 내부 인터페이스 연결, 둘 사이의 데이터 전송 및 워크로드에 대한 L2 세그먼트(VXLAN)가 필요합니다.
