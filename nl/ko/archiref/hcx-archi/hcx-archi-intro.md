...
VMware HCX on IBM Cloud 서비스는 워크로드에 대한 원활한 네트워크 확장 및 양방향 마이그레이션을 작성하여 VCS의 인스턴스를 기존의 온프레미스 가상화 데이터 센터와 결합시킴으로써 이 하이브리디티를 더욱 발전시킵니다.
...
* [가상화된 사설 클라우드를 확장하기 위한 가상화](https://www.ibm.com/cloud/garage/architectures/virtualizationArchitecture)
