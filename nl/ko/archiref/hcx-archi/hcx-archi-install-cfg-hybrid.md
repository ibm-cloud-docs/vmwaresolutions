...
### 하이브리드 서비스 가상 어플라이언스 설치 및 구성에 대한 전제조건
...
하이브리드 클라우드 게이트웨이 서비스 가상 어플라이언스 구성

### 하이브리드 클라우드 게이트웨이 구성에 대한 전제조건

_하이브리드 서비스 가상 어플라이언스 설치 및 구성 시작_의 단계를 따르고 하이브리드 클라우드 게이트웨이를 선택하십시오.
...
단일 경로 배치 또는 대체 경로의 독립형 네트워크 확장을 위해 네트워크 확장 서비스를 구성하십시오.

### 네트워크 확장 서비스 구성에 대한 전제조건

네트워크 확장 서비스를 선택하십시오. 단일 경로 구성이 설치된 경우 **네트워크 확장**만 선택할 수 있습니다.
...
네트워크를 확장하려면 네트워크 확장 서비스가 작동되어야 합니다.
