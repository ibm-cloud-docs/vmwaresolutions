...
IBM Cloud for VMware Solutions의 일부로, Veeam 백업 소프트웨어는 VMware 클러스터 외부에서 IBM Cloud Endurance Storage를 사용하여 IBM Cloud VSI(Virtual Server Instance)에 선택적으로 배치됩니다. 이 소프트웨어의 목적은 이 솔루션의 관리 컴포넌트를 백업하는 것입니다. 
...
플랫폼 레벨의 IBM Cloud Private는 다음 컴포넌트를 백업해야 합니다.
...
초기 호스트를 배치하고 나면 사용자는 IBM Cloud for VMware 포털 내에서 컴퓨팅 기능을 확장할 수 있습니다.
...
####	다중 사이트 배치
VMware on IBM Cloud는 IBM Cloud의 전 세계 데이터 센터 및 통합 네트워크 백본을 활용하여 다양한 교차 지역의 유스 케이스를 배치하고 처음부터 이러한 인프라를 빌드하는 데 걸리는 시간 내에 작동되도록 할 수 있습니다. 
...
###  IKS 확장
사용자는 IBM Cloud Portal을 통해 IKS 환경을 프로비저닝하여 컨테이너 환경을 확장/이용할 수 있습니다.
...
* [기존 작업자 풀을 크기 조정하여 작업자 노드 추가](https://console.bluemix.net/docs/containers/cs_clusters.html#add_workers)
* [IBM Cloud Private 백업 및 복원 방법](https://medium.com/ibm-cloud/how-to-backup-and-restore-ibm-cloud-private-part-1-b6300dc1d7d8)
* [ICP 백업](https://github.com/ibm-cloud-architecture/icp-backup/)
