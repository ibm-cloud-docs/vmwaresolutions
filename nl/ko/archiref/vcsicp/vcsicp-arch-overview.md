...
NSX-T를 사용하는 {{site.data.keyword.icpfull_notm}}의 경우 사용자가 중앙 UI(NSX-T 관리자)에서 네트워킹, 서브넷, 정책을 제어하고 구성할 수 있습니다. NSX-V와 NSX-T의 차이점은 [vCenter Server 네트워킹 안내서](../vcsnsxt/vcsnsxt-intro.html)를 참조하십시오.
