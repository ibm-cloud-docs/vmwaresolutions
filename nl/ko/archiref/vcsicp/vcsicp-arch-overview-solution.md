...
관리 노드는 모니터링, 미터링 및 로깅과 같은 관리 서비스만 호스팅하는 선택적 노드입니다. 전용 관리 노드를 구성하면, 마스터 노드에 과부하가 발생하는 것을 방지할 수 있습니다. ICP 설치 중에만 관리 노드를 사용으로 설정할 수 있습니다.
...
고가용성 ICP 인스턴스에는 다음 VM 스펙이 필요합니다.
