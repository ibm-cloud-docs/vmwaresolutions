...
주문한 VMware Cloud Foundation 인스턴스와 이에 대한 자세한 정보를 보십시오.

## Cloud Foundation 인스턴스 요약 보기

환경에 있는 모든 Cloud Foundation 인스턴스의 요약을 보려면 다음 단계를 완료하십시오.

1. {{site.data.keyword.vmwaresolutions_short}} 콘솔의 왼쪽 탐색 분할창에서 **배치된 인스턴스**를 클릭하십시오.
2. **Cloud Foundation 인스턴스** 테이블에서 인스턴스의 목록을 보십시오.

표 1. Cloud Foundation 인스턴스 항목
...
표 2. Cloud Foundation 인스턴스 상태 설명
...
## Cloud Foundation 인스턴스 특성 세부사항 보기

인스턴스의 특성 세부사항을 보려면 다음 작업을 수행하십시오.

1. **Cloud Foundation 인스턴스** 테이블에서 인스턴스 이름을 클릭하십시오.
2. **특성**에서 인스턴스의 세부사항을 보십시오.

표 3. Cloud Foundation 인스턴스 특성
...
|_VMware 컴포넌트_ 라이센스 |인스턴스를 주문할 때 **라이센스 부여** 페이지에서 모든 VMware 컴포넌트에 고유한 VMware 라이센스를 사용하도록 선택한 경우 컴포넌트에 대해 입력한 VMware 컴포넌트 이름 및 라이센스 키가 표시됩니다.<br><br>VMware 컴포넌트 라이센스의 예는 **vCenter Server 라이센스** 및 **NSX 라이센스**입니다. |
...
|DNS, SSO 도메인 |SSO 도메인은 vSphere Single Sign-On 도메인입니다. SSO 도메인 이름은 배치된 모든 Cloud Foundation 인스턴스(<samp class="ph codeph">vsphere.local</samp> 값 포함)에 대해 수정됩니다. |
|DNS, 하위 도메인 |하위 도메인은 로컬 Cloud Foundation 인스턴스 호스트 이름이 상주하는 루트 도메인 이름의 DNS 하위 도메인 이름입니다. 하위 도메인 이름은 <samp class="ph codeph"><var class="keyword varname">vcenter_server_instance_name</var>.<var class="keyword varname">root.domain_name</var></samp> 형식으로 되어 있습니다. |
|SDDC Manager 버전  |인스턴스의 SDDC Manager 버전입니다. |
...
## Cloud Foundation 인스턴스에 대한 액세스 정보 보기
...
표 4. 인스턴스 관련 컴포넌트에 대한 Cloud Foundation 액세스 정보
...
|NSX Manager SSH |SSH 연결을 통해 NSX Manager에 액세스하는 데 사용할 수 있는 사용자 이름 및 비밀번호입니다. |
...
## Cloud Foundation 인스턴스에 대한 배치 히스토리 보기

**배치 히스토리**에서 인스턴스의 배치 히스토리를 보십시오.

표 5. Cloud Foundation 인스턴스 배치 히스토리
