...
표준화된 **소형** 및 **대형** Bare Metal Server 구성은 변경할 수 없는 기본 팟(Pod)을 사용합니다.
{:note}
...
**Skylake**, **Broadwell** 또는 **사전 구성됨**을 선택할 수 있습니다.
...
6. Bare Metal Server 구성을 완료하십시오.
   * **Skylake** 또는 **Broadwell**을 선택한 경우 **CPU 모델** 및 **RAM** 크기를 선택하십시오.
