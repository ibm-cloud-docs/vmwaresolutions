...
다음 표에서는 Cloud Foundation 인스턴스에서 사용 가능한 서비스를 표시합니다.
...
| [VMware HCX on IBM Cloud](../services/hcx_considerations.html)                         |아니오              |
| [Zerto on IBM Cloud](../services/addingzertodr.html)                                 |예              |

## Cloud Foundation 인스턴스에 서비스 추가

Cloud Foundation 인스턴스에 서비스를 추가하려면 이전 테이블의 해당 서비스 링크를 클릭하여 서비스에 대한 고려사항을 검토하고 배치된 컴포넌트를 확인하십시오. 그런 다음 서비스 주문 주제의 지시사항에 따라 인스턴스에 서비스를 추가하십시오.

### 서비스 설치 결과

서비스 설치가 완료되면 이메일로 알림을 받고 서비스가 **설치됨** 상태로 인스턴스의 **서비스** 페이지에 표시됩니다.

## Cloud Foundation 인스턴스에 대한 서비스 보기
...
## Cloud Foundation 인스턴스에 대한 서비스 제거
