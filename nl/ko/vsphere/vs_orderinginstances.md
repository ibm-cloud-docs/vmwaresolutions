...
### (IBM 비즈니스 파트너만 해당) 컴포넌트 번들

IBM 비즈니스 파트너는 새 vSphere 클러스터를 주문할 때 컴포넌트 라이센스 번들을 선택할 수 있습니다. 다음 번들이 사용 가능합니다.
...
구성에 따라 예상 비용이 즉시 생성되어 오른쪽에 있는 **주문 요약** 분할창에 표시됩니다. 예상 세부사항을 제공하는 PDF 문서를 생성하려면 **가격 책정 세부사항**을 클릭하십시오.
