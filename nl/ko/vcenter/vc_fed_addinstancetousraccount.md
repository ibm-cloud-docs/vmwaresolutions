...
# IBM Cloud 계정으로 V2.5 이전 VMware Federal 인스턴스 마이그레이션

{{site.data.keyword.cloud}} 계정의 V2.5 이상 릴리스에 배치된 VMware Federal 인스턴스는 자동으로 사용자 계정에 추가되며 {{site.data.keyword.cloud_notm}} IAM(Identity and Access Management)에 의해 관리됩니다.
