...
## VMware Federal 인스턴스 요약 보기

사용자 계정에 대해 프로브저닝된 모든 VMware Federal 인스턴스의 요약을 보려면 다음 단계를 완료하십시오.
...
## VMware Federal 인스턴스 특성 세부사항 보기
...
## VMware Federal 인스턴스에 대한 액세스 정보 보기
...
## VMware Federal 인스턴스의 배치 히스토리 보기
