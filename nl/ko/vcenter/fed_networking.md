...
VMware Federal 인스턴스에 포함된 네트워킹 컴포넌트를 검토하려면 [VMware Federal on IBM Cloud의 vCenter Server 인스턴스 컴포넌트](vc_fed_overview.html#vcenter-server-instance-components-for-vmware-federal-on-ibm-cloud)를 참조하십시오.
