...
IBM Cloud Private Hosted V3.1은 마이그레이션 및 앱 현대화를 위한 모든 단일 노드 평가판 인스턴스의 문서/테스트 토폴로지를 사용하여 설치됩니다. IBM Cloud Private Hosted에 대한 자세한 정보는 [IBM Cloud Private Hosted 개요](../services/icp_overview.html)를 참조하십시오.
