...
IBM Cloud {{site.data.keyword.CloudDataCents_notm}}의 소형 서브세트는 사전 구성된 **소형**, **중형** 및 **대형** Bare Metal Server 옵션을 제공합니다. 가용성 및 자원 명세 제공에 따라 {{site.data.keyword.CloudDataCents_notm}}는 {{site.data.keyword.vmwaresolutions_full}} 콘솔에 상태 표시기를 표시하여 배치를 계획할 수 있습니다.
