...
vCenter Server with Hybridity Bundle 인스턴스에 포함된 네트워킹 컴포넌트를 검토하려면 [vCenter Server with Hybridity Bundle 개요](vc_hybrid_overview.html)의 _vCenter Server with Hybridity Bundle 기술 스펙_ 절을 참조하십시오.
...
* [VMware HCX on IBM Cloud 개요](../services/hcx_considerations.html)
