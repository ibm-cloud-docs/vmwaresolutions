...
표 4. 인스턴스 관련 컴포넌트에 대한 vCenter Server with Hybridity Bundle 액세스 정보
...
* [vCenter Server with Hybridity Bundle 인스턴스의 클러스터 추가, 보기 및 삭제](/docs/services/vmwaresolutions/vcenter/vc_hybrid_addingviewingclusters.html)
