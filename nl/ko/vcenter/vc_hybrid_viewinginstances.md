...
|상태 |인스턴스의 상태입니다. |
{: caption="표 1. vCenter Server with Hybridity Bundle 인스턴스 항목" caption-side="top"}
...
|삭제됨 |인스턴스가 삭제됩니다. |
{: caption="표 2. vCenter Server with Hybridity Bundle 인스턴스 상태 설명" caption-side="top"}
...
|DNS, SSO 도메인 |SSO 도메인은 vSphere Single Sign-On 도메인입니다. SSO 도메인 이름은 배치된 모든 vCenter Server with Hybridity Bundle 인스턴스에서 값 <samp class="ph codeph">vsphere.local</samp>로 고정되어 있습니다. |
|DNS, 하위 도메인 | 하위 도메인은 로컬 vCenter Server with Hybridity Bundle 인스턴스 호스트 이름이 있는 루트 도메인 이름의 DNS 하위 도메인 이름입니다. 하위 도메인 이름은 <samp class="ph codeph"><var class="keyword varname">vcenter_server_instance_name</var>.<var class="keyword varname">root.domain_name</var></samp> 형식으로 되어 있습니다. |
...
{: caption="표 3. vCenter Server with Hybridity Bundle 인스턴스 특성" caption-side="top"}
...
{: caption="표 4. 인스턴스 관련 컴포넌트에 대한 vCenter Server with Hybridity Bundle 액세스 정보" caption-side="top"}
...
|요약 |변경의 세부사항입니다. |
{: caption="표 5. vCenter Server with Hybridity Bundle 인스턴스 배치 히스토리" caption-side="top"}
