...
# vCenter Server on IBM Cloud 인스턴스에 대한 다중 사이트 구성
{: #vc_multisite}
...
![vCenter Server 다중 사이트 배치](../sddc/multisite-hub-spoke.svg "vCenter Server 다중 사이트 배치")
...
다중 사이트 구성의 일부인 vCenter Server 인스턴스를 삭제하려면 특수 계획이 필요합니다. 자세한 정보는 [다중 사이트 구성에서 vCenter Server 인스턴스 삭제](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_deletinginstance_multi)를 참조하십시오.
{:note}
