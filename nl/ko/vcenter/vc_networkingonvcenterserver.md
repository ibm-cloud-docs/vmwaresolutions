...
vCenter Server 인스턴스에 포함된 네트워킹 컴포넌트를 검토하려면 [vCenter Server 인스턴스의 기술 스펙](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_vcenterserveroverview#technical-specifications-for-vcenter-server-instances)을 참조하십시오.
