...
vCenter Server on {{site.data.keyword.cloud}} 인스턴스에 대한 네트워킹 고려사항 및 요구사항에 대한 세부사항은 다음 정보를 검토하십시오. 인스턴스가 올바르게 작동하도록 요구사항을 충족하는지 확인하십시오.

## vCenter Server 인스턴스에 대한 네트워킹 컴포넌트
{: #vc_networkingonvcenterserver-networking-components}
{: faq}

vCenter Server 인스턴스에 포함된 네트워킹 컴포넌트를 검토하려면 [vCenter Server 인스턴스의 기술 스펙](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_vcenterserveroverview#specs)을 참조하십시오.
