...
{{site.data.keyword.cloud}} 계정의 V2.5 이상에 배치된 VMware vCenter Server with Hybridity Bundle 인스턴스는 자동으로 사용자 계정에 추가됩니다. 이러한 인스턴스는 {{site.data.keyword.cloud_notm}} IAM(Identity and Access Management)에서 관리합니다.
