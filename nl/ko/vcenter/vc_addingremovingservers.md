...
4. 다음 상황에서는 ZVM(Zerto Virtual Manager) 콘솔 및 사전에 채워진 Zerto Virtual Replication Appliance(VRA) IP 주소를 사용하여 수동으로 VRA 가상 머신을 배치해야 합니다.
...
유지보수 모드 동안 ESXi 서버를 추가하는 경우, 유지보수 모드를 제거할 때까지 VM이 새 서버에 마이그레이션되지 않습니다.   
{:important}
...
* [vCenter Server 인스턴스의 클러스터 추가, 보기 및 삭제](/docs/services/vmwaresolutions/services?topic=vmware-solutions-vc_addingviewingclusters#vc_addingviewingclusters)
