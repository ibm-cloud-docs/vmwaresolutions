...
| [FortiGate Security Appliance on {{site.data.keyword.cloud_notm}}](../services/fortinetvm_considerations.html) |예 | V2.0 이상 |
...
## vCenter Server 인스턴스에 대한 서비스 보기
...
## vCenter Server 인스턴스에 대한 서비스 제거
