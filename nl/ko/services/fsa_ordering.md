...
* {{site.data.keyword.cloud_notm}} 카탈로그에서 왼쪽 탐색 분할창에 있는 **VMware** 아이콘을 클릭한 다음 **VMware Services** 섹션에 있는 **FortiGate Security Appliance on IBM Cloud** 카드를 클릭하십시오. 서비스 설정을 지정하고 **새 인스턴스에 추가**를 선택하십시오.
...
* {{site.data.keyword.cloud_notm}} 카탈로그에서 왼쪽 탐색 분할창에 있는 **VMware** 아이콘을 클릭한 다음 **VMware Services** 섹션에 있는 **FortiGate Security Appliance on IBM Cloud** 카드를 클릭하십시오. 서비스 설정을 지정하고 **기존 인스턴스에 추가**를 선택하십시오.
