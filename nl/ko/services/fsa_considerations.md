...
* FortiGate Security Appliance on {{site.data.keyword.cloud_notm}} 서비스를 배치된 인스턴스에 추가하려면 아직 인스턴스의 공용 VLAN에 {{site.data.keyword.cloud_notm}} 인프라의 다른 방화벽이 없는지 확인하십시오.
