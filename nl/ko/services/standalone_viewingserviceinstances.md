...
|:------------- |:------------- |
|이름 |인스턴스의 이름입니다. |
|정품 인증 키 |온프레미스 HCX on {{site.data.keyword.cloud_notm}} 인스턴스의 정품 인증 키입니다. |  
|작성 시간 |인스턴스가 작성된 날짜 및 시간입니다. |
|상태 |인스턴스의 상태입니다. |  
|조치 |인스턴스를 삭제하려면 **삭제** 아이콘을 클릭하십시오. |
{: caption="표 1. 온프레미스 HCX on {{site.data.keyword.cloud_notm}} 인스턴스 항목" caption-side="top"}
...
|제거 중 |인스턴스가 삭제 중입니다. |
{: caption="표 2. 온프레미스 HCX on {{site.data.keyword.cloud_notm}} 인스턴스 상태 설명" caption-side="top"}
