...
|환경 | 코어 |  메모리(GB) | 호스트 | 스토리지(GB) |
|:---------- |:---- |:------ |:---- |:------- |
| 프로덕션 준비 | 52 | 640 | 3 | 8,000 |
...
* 프로덕션 준비 환경의 {{site.data.keyword.cloud_notm}} Private Hosted 배치의 경우 호스트당 64GB RAM이 지원되지 않습니다. 따라서 **RAM**에 대해 64GB보다 높은 옵션을 선택해야 합니다.
