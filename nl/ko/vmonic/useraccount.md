...
3. **IBM Cloud 인프라 신임 정보** 영역에서 다음 방법 중 하나를 사용하여 {{site.data.keyword.cloud_notm}} 인프라 (SoftLayer) 계정의 사용자 이름과 API키를 입력하십시오. 
   * {{site.data.keyword.cloud_notm}} 인프라(SoftLayer) 계정과 {{site.data.keyword.cloud_notm}} 계정이 링크된 경우에는 **검색**을 클릭하여 신임 정보를 자동으로 입력하십시오. 
   * {{site.data.keyword.cloud_notm}} 인프라(SoftLayer) 계정과 {{site.data.keyword.cloud_notm}} 계정이 링크되지 않은 경우에는 [{{site.data.keyword.cloud_notm}} 인프라 고객 포털](https://control.softlayer.com/)에 로그인한 후에 콘솔의 지시사항에 따라 신임 정보를 가져와서 이를 입력하십시오. 
   * {{site.data.keyword.cloud_notm}} 인프라(SoftLayer) 계정이 없는 경우에는 [계정을 등록](../vmonic/signing_softlayer_account.html)한 후에 콘솔의 지시사항에 따라 신임 정보를 가져와서 이를 입력하십시오. 
4. **신임 정보 저장**을 클릭하십시오.
...
이메일 또는 콘솔 알림이 특정 인스턴스 이벤트에 대해 사용으로 설정되는 경우 이벤트가 발생할 때 이메일 또는 콘솔 메시지로 알림을 받습니다.
