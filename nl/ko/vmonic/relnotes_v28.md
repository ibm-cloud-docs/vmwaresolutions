...
자세한 정보는 [마이그레이션 및 앱 현대화를 위한 단일 노드 평가판 개요](/docs/services/vmwaresolutions/vcenter/cloud_modern_bundle_overview.html)를 참조하십시오.
...
자세한 정보는 [vCenter Server 인스턴스에 대한 용량 확장 및 축소](/docs/services/vmwaresolutions/vcenter/vc_addingremovingservers.html#adding-nfs-storage-to-vcenter-server-instances)의 *NFS 스토리지를 vCenter Server 인스턴스에 추가* 및 *vCenter Server 인스턴스에서 NFS 스토리지 제거* 섹션을 참조하십시오.
...
자세한 정보는 다음의 *{{site.data.keyword.baremetal_short_sing}} 설정* 섹션을 참조하십시오.
* [vCenter Server 인스턴스 주문](/docs/services/vmwaresolutions/vcenter/vc_orderinginstance.html#bare-metal-server-settings)
* [vCenter Server with Hybridity Bundle 인스턴스 주문](/docs/services/vmwaresolutions/vcenter/vc_hybrid_orderinginstance.html#bare-metal-server-settings)
...
자세한 정보는 [vCenter Server 개요](/docs/services/vmwaresolutions/vcenter/vc_vcenterserveroverview.html#vcenter-server-architecture)에서 *vCenter Server 아키텍처* 섹션을 참조하십시오.
...
KMIP for VMware on {{site.data.keyword.cloud_notm}} 솔루션 아키텍처에 대한 새 기술 문서는 사용자 문서의 *참조* 섹션에서 할 수 있습니다. 자세한 정보는 [KMIP for VMware 개요](/docs/services/vmwaresolutions/archiref/kmip/overview.html)를 참조하십시오.
