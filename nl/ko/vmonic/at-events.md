...
자세한 정보는 [활동 트래커 이벤트 필드](https://console.bluemix.net/docs/services/cloud-activity-tracker/at_event.html#at_event)를 참조하십시오.
...
* [활동 트래커 프로비저닝](../../cloud-activity-tracker/how-to/provision.html)
* [{{site.data.keyword.cloud_notm}} 콘솔에서 활동 트래커 대시보드로 이동](../../cloud-activity-tracker/how-to/manage-events-ui/launch_at_ui.html)
* [KMIP for VMware on {{site.data.keyword.cloud_notm}} 개요](../services/kmip_standalone_considerations.html)
