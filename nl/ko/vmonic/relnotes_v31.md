...
* 참조 문서는 새 ``Retrieve the detailed network interface of a cluster`` API에서 사용 가능합니다. 자세한 정보는 [API 참조](https://cloud.ibm.com/apidocs/vmware-solutions){:external}를 참조하십시오.
