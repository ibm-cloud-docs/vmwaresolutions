...
* [Zerto 재해 복구](/docs/services/vmwaresolutions/services/addingzertodr.html)
...
자세한 정보는 [사용자 계정 및 설정](/docs/services/vmwaresolutions/vmonic/useraccount.html)을 참조하십시오.
