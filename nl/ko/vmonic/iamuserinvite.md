...
4. **액세스** 섹션에서 **서비스**를 펼치고 다음 태스크를 완료하십시오. 
   ...
   3. 사용자에게 지정할 플랫폼 액세스 역할을 선택하십시오(예: **관리자**, **편집자**, **운영자** 또는 **뷰어**).
5. **사용자 초대**를 클릭하십시오. 

## 결과

추가된 사용자가 초대를 수락한 후에 이 사용자는 {{site.data.keyword.vmwaresolutions_short}} 콘솔에 로그인하고 {{site.data.keyword.vmwaresolutions_short}} 콘솔의 오른쪽 상단 모서리에서 자신의 아바타를 클릭하여 자체 프로파일 설정의 계정으로 전환할 수 있습니다. 그리고 추가된 사용자는 지정된 계정에서 사용 가능한 서비스와 리소스에 대해 협업하고 이를 공유할 수 있습니다. 
