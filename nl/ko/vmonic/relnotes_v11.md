...
이제 자세한 상태 정보는 Cloud Foundation 인스턴스에 사용할 수 있습니다. 인스턴스 이름을 클릭할 때 표시되는 상태 정보는 배치 진행상태에 대한 추가 세부사항을 제공합니다. 오류가 발생하는 경우 문제에 대한 도움을 제공하도록 메시지가 표시됩니다. 자세한 정보는 [Cloud Foundation 인스턴스 보기](/docs/services/vmwaresolutions/sddc?topic=vmware-solutions-sd_viewinginstances)를 참조하십시오.
