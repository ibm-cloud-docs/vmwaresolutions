...
1. https://console.ng.bluemix.net/ 사이트로 이동하십시오.
2. **IBM ID** 계정으로 {{site.data.keyword.cloud_notm}}에 로그인하십시오.
3. 배너의 왼쪽에서 **카탈로그**를 클릭하십시오. 
4. **카탈로그** 페이지 맨 위의 검색 상자에서 **VMware 솔루션**을 입력하십시오. 
5. **VMware 솔루션** 카드를 클릭하십시오. 

## ibm.com 웹 사이트에서 액세스

ibm.com 웹 사이트에서 콘솔에 액세스하려면 다음 단계를 완료하십시오.
1. http://www.ibm.com 사이트로 이동하십시오.
2. **제품 > IBM Cloud > VMware on IBM Cloud**를 클릭하십시오.
3. 배너의 왼쪽에서 **클라우드 > 솔루션**을 클릭하십시오. 
4. 페이지에서 아래로 스크롤하고 **VMware**를 클릭하십시오. 
