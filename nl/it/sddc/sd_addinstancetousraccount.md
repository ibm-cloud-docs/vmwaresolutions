...
# Migrazione di istanze Cloud Foundation precedenti alla V2.5 agli account IBM Cloud

Le istanze VMware Cloud Foundation che sono state distribuite nelle release della V2.5 e successive nel tuo account {{site.data.keyword.cloud}} vengono aggiunte automaticamente al tuo account e gestite da {{site.data.keyword.cloud_notm}} Identity and Access Management (IAM).
...
3. Nella tabella **Istanze Cloud Foundation**, trova l'istanza precedente alla V2.5.
