...
Console di gestione | La console di gestione {{site.data.keyword.icpfull_notm}} consente di gestire, monitorare e risolvere i problemi delle tue applicazioni e del tuo cluster da una singola console di gestione centralizzata e sicura.
