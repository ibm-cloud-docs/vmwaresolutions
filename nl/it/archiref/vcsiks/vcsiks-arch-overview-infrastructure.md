...
Figura 1. Struttura fisica delle distribuzioni {{site.data.keyword.containerlong_notm}} e {{site.data.keyword.icpfull_notm}}

![Diagramma della struttura fisica delle distribuzioni {{site.data.keyword.containerlong_notm}} e {{site.data.keyword.icpfull_notm}}]
