...
* Per qualsiasi VM sull'host che utilizza una politica di archiviazione della VM con un'impostazione uguale a 1 per **Number of failures to tolerate**, la VM diventa non ridondante quando l'host entra in modalità di manutenzione. Se questo non è accettabile, vedi [Ridondanza vSAN della macchina virtuale](/docs/services/vmwaresolutions/archiref/vum?topic=vmware-solutions-vum-vsan-redundancy).
