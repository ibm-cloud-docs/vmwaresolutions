...
Le informazioni dettagliate sullo stato sono ora disponibili per le istanze Cloud Foundation. Quando fai clic su un nome di istanza, le informazioni sullo stato visualizzate forniscono ulteriori dettagli sull'avanzamento della distribuzione. Se si verifica un errore, vengono visualizzati i messaggi per risolvere il problema. Per ulteriori informazioni, vedi [Visualizzazione delle istanze Cloud Foundation](/docs/services/vmwaresolutions/sddc?topic=vmware-solutions-sd_viewinginstances).
