...
*  Implementazione completa della specifica della V2.0 per l'offerta di vCenter Server.
...
*  Nuovo gateway dei servizi edge VMware NSX per l'utilizzo da parte del cliente.
   ...
   * VMware HA (High Availability) è configurato per utilizzare un nuovo gruppo di porte condiviso tra l'ESG di gestione e l'ESG gestito
   ...
   seguenti argomenti:
   *  [Configurazione della rete per utilizzare l'ESG NSX gestito dal cliente con le tue VM](/docs/services/vmwaresolutions/vcenter?topic=vmware-solutions-vc_esg_config)
