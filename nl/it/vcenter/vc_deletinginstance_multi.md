...
Prima di pianificare l'eliminazione delle istanze vCenter Server che fanno parte di una configurazione multisito, è necessario tenere conto di alcune considerazioni speciali.
