...
## Visualizzazione dei dettagli delle proprietà delle istanze vCenter Server with Hybridity Bundle
...
| DNS, Dominio SSO | Il dominio SSO è il dominio vSphere Single Sign-On. Il nome del dominio SSO viene fissato per tutte le istanze distribuite di vCenter Server with Hybridity Bundle con il valore <samp class="ph codeph">vsphere.local</samp>. |
...
## Visualizzazione delle informazioni di accesso per le istanze vCenter Server with Hybridity Bundle
