...
Per esaminare i componenti di rete inclusi nella tua istanza VMware Federal, vedi [Componenti dell'istanza vCenter Server per VMware Federal on IBM Cloud](vc_fed_overview.html#vcenter-server-instance-components-for-vmware-federal-on-ibm-cloud).
...
Durante la distribuzione dell'istanza VMware Federal, VMware NSX viene ordinato, installato, concesso in licenza e configurato nella tua istanza. Inoltre, vengono configurati il gestore NSX, i controller NSX e NSX Transport Zone e ciascun server ESXi viene configurato con i componenti NSX.
