...
Visualizza le istanze VMware vCenter Server che hai ordinato e informazioni dettagliate su di esse.

## Visualizzazione del riepilogo delle istanze vCenter Server

Per visualizzare un riepilogo di tutte le istanze vCenter Server nel tuo ambiente, completa la seguente procedura:
