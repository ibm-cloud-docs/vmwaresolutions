...
4. Accedi alla console utilizzando le credenziali della console che puoi trovare nella pagina dei dettagli del servizio HyTrust DataControl on IBM Cloud nella console {{site.data.keyword.vmwaresolutions_short}}.
