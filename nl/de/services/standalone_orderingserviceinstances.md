...
*  Sie haben alle Hinweise im Abschnitt [Hinweise zur Installation von lokalen HCX on {{site.data.keyword.cloud_notm}}-Instanzen](/docs/services/vmwaresolutions/services/standalone_considerations.html) gelesen.
