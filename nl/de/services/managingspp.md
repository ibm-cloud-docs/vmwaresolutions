...
Der Service "IBM Spectrum Protect Plus on {{site.data.keyword.cloud_notm}}" ist mit einem Managementsicherungsjob vorkonfiguriert, der automatisch ausgeführt wird. Dieser Job wird täglich ausgeführt und sichert die folgenden Managementkomponenten mit bis zu sieben Wiederherstellungspunkten:
