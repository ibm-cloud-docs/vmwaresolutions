...
* Wählen Sie im {{site.data.keyword.cloud_notm}}-Katalog **Veeam on IBM Cloud** aus, geben Sie die Serviceeinstellungen an und wählen Sie **Zu neuer Instanz hinzufügen** aus.
...
* Wählen Sie im {{site.data.keyword.cloud_notm}}-Katalog **Veeam on IBM Cloud** aus, geben Sie die Serviceeinstellungen an und wählen Sie **Zu vorhandener Instanz hinzufügen** aus.
