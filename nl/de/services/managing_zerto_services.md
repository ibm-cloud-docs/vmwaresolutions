...
3. Prüfen Sie auf der Seite **Verwaltete Services für Zerto on IBM Cloud bestellen** die Beschreibung und die technischen Spezifikationen für Zerto on {{site.data.keyword.cloud_notm}} als verwalteter Service und klicken Sie auf **Erstellen**.
