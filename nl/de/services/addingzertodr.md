...
# Überblick zu Zerto on IBM Cloud
...
## Komponenten des Service "Zerto on IBM Cloud"

Mit dem Service "Zerto on {{site.data.keyword.cloud_notm}}" werden die folgenden Komponenten bestellt und einbezogen:

* Privates portierbares Teilnetz aus der {{site.data.keyword.cloud_notm}}-Infrastruktur für die Verwendung durch Zerto Virtual Replication Appliances
* Virtuelle Serverinstanz (VSI) von Microsoft Windows, auf der Zerto Virtual Replication installiert wird
* Zerto Virtual Replication Appliances zur Bereitstellung und Konfiguration in allen ESXi-Servern
