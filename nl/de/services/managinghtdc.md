...
4. Melden Sie sich an der Konsole mithilfe der Konsolenberechtigungsnachweise an, die auf der Detailseite des Service 'HyTrust DataControl on {{site.data.keyword.cloud_notm}}' in der {{site.data.keyword.vmwaresolutions_short}}-Konsole angegeben sind.
