...
3. Erstellen Sie einen neuen Cluster mit denselben Einstellungen wie Ihr vorhandener Cluster, der außerhalb der {{site.data.keyword.vmwaresolutions_short}}-Konsole erstellt wird. Weitere Informationen finden Sie unter [Neue vSphere-Cluster bestellen](vs_orderinginstances.html).  
...
7. Klicken Sie auf die Registerkarte **Vorhandene skalieren** und wählen Sie den gerade erstellten Cluster in der Liste **Clusterkonfigurationen** aus.
