...
|:-------------|:--------------------------------|:--------|
| VMware       | vSphere ESXi                    | Entweder 6.7u2 oder 6.5u2 |
{: caption="Tabelle 1. Teileliste für VMware vSphere-Cluster" caption-side="top"}

## Zugehörige Links
{: #vs_bom-related}

* [Build numbers and versions of VMware ESXi/ESX (2143832)](https://kb.vmware.com/s/article/2143832){:external}
* [VMware ESXi 6.0u2 Release Notes](https://docs.vmware.com/en/VMware-vSphere/6.0/rn/vsphere-esxi-60u2-release-notes.html){:external}
