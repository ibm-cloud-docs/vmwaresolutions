...
Sie können einen vorhandenen VMware vSphere-Cluster, den Sie bestellt oder gespeichert haben, in der {{site.data.keyword.vmwaresolutions_full}}-Konsole skalieren, indem Sie ESXi-Server hinzufügen oder ein HA-Paar für FortiGate 300 Series Security Appliance für den Cluster bestellen.
...
4. Überprüfen Sie die Clustereinstellungen, die automatisch eingetragen wurden.
