...
Die technischen Spezifikationen für die Bare Metal Server sehen wie folgt aus:
...
* Primäre IP-Adressen werden Einheiten (Geräten), Bare Metal Servern und virtuellen Servern zugeordnet, die von {{site.data.keyword.cloud_notm}} bereitgestellt werden. Sie sollten keine IP-Adressen in diesen Blöcken zuweisen.
