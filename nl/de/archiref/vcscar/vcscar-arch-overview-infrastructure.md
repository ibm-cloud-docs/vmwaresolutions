...
Die physische Infrastruktur, die zur Bereitstellung einer ICP-Produktionsinstanz (ICP = {{site.data.keyword.cloud_notm}} Private) für einen VMware vCenter Server (VCS) on {{site.data.keyword.cloud_notm}}-Cluster erforderlich ist, setzt folgende Mindestspezifikationen voraus.
...
Abbildung 1. Struktur der vCenter Server- und ICP-Bereitstellung ![Struktur der vCenter Server- und ICP-Bereitstellung](vcscar-icp.svg)
