...
ICP verfügt über eine große Auswahl an Inhalten; sowohl Todd als auch Jane muss entscheiden, was ihre Anforderungen am besten erfüllt. Beim Blick in den ICP-Katalog stellt Todd fest, dass ein Großteil des Inhaltes zum Ausprobieren verfügbar ist, jedoch einiger Inhalt gekauft und bei Passport Advantage heruntergeladen werden muss.

* Toolchain & Laufzeiten
  -	UrbanCode Deploy
  -	Microclimate
  -	Jenkins (Open Source)
  -	IBM WebSphere Liberty (MicroProfile, Webprofil, Profil für Java Platform, Enterprise Edition)
...
* Management
  -	IBM Netcool - Integration (Testmonitor für ICP-Services - Ereignisprotokollierung und Alertüberwachung)
  - {{site.data.keyword.cloud_notm}} App Management 2018.2.0
  -	IBM Netcool - Integration (Testmonitor für die Verwaltung von ICP-Ereignissen; wird mit dem Produkt "IBM Netcool Insights" verkauft)
  ...
  - IBM Operations Analytics Predictive Insights Mediation Pack (Verwaltung von ICP-Überwachungsmetriken; mit ILAN-Lizenz für Erkennung und Test aus Katalog)
  -	IBM Operations Analytics Predictive Insights Mediation Pack (wird mit Produkt "Predictive Insights" verkauft)
...
Da Todd ICP vorbereitet hat, hat er bereits seine Podsicherheitsrichtlinie definiert. Er kann sich nun auf die Erstellung eines geheimen Schlüssels für Docker-Images konzentrieren:
...
Wechseln Sie in das ICP-Dashboard und erstellen Sie persistente Datenträger. Die erforderliche Größe können Sie der Readme-Datei entnehmen:
...
ICP-Dashboard > Katalog > Eingabe mit MQ beginnen > Auswahl von "ibm-mqadvanced-server-dev".  Anschließend muss die Readme-Datei gelesen und auf "Konfigurieren" geklickt werden, danach werden die folgenden Eingabewerte zur Verfügung gestellt bzw. geprüft:
