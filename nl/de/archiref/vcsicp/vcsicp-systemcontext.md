...
Abbildung 1. Diagramm des Systemkontextes
![Diagramm des Systemkontextes - vCenter Server, ICP, CAM](vcsicp-syscontext-vcs-icp-cam.svg)
...
Entwickler | Mitarbeiter mit Container-Know-how, der die CAM-Konsole verwendet, um Container zu erstellen und zu verwalten. Er richtet die neuen Services im Rahmen der Anwendungsmodernisierung ein. Mit CAM können die Entwickler die Workloads auf vCenter Server, ICP oder IKS bereitstellen, die mit VMs und Containern erstellten Services zusammensetzen und koordinieren und DevOps-Toolchains und Day-2-ITSM-Lösungen integrieren.
...
Managementkonsole | Die ICP-Managementkonsole führt das Management, die Überwachung und die Fehlerbehebung Ihrer Anwendungen und Cluster von einer einzigen, zentralen und sicheren Managementkonsole aus.
...
Die Anwendungsmigration, der Netzbetrieb und die Sicherheit stellen häufig die anspruchsvollsten Aspekte der Anwendungsmodernisierung dar. vCenter Server, VMware Hybridity, VMware NSX, ICP und der {{site.data.keyword.cloud_notm}} Kubernetes-Service bewältigen diese Herausforderungen und ermöglichen Ihnen das Erstellen widerstandsfähiger, sicherer und leistungsfähiger moderner Anwendungen.
