...
HyTrust DataControl und KeyControl können Sie bei der Bereitstellung des Schutzes von Workloads wie Verschlüsselung ruhender Daten und Geofencing unterstützen. Möglicherweise sind Sie an einer Bereitstellung des Caveonix RiskForesight-Service interessiert, damit Sie nicht nur Unterstützung für Ihre Konformitätsanforderungen, sondern auch für Cyberrisiken und forensisches Management erhalten.

Die VMware-Richtlinien zur Sicherheitshärtung stellen bindende Anleitungen für die sichere Bereitstellung und den sicheren Betrieb von VMware-Produkten bereit. Richtlinien für vSphere werden mit umfangreichen Metadaten in einem einfach zu lesenden Tabellenformat bereitgestellt, um eine Klassifizierung der Richtlinien und eine Risikobewertung zu ermöglichen. Sie enthalten auch Scriptbeispiele zur Aktivierung der Automatisierung von Sicherheit. Es werden Vergleichsdokumente bereitgestellt, in denen die Änderungen an den Anleitungen in den aufeinander folgenden Versionen des Handbuchs aufgelistet sind.
