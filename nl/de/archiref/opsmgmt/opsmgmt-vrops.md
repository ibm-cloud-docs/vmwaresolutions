...
Der Analysecluster mit 4 Knoten besteht aus Folgendem: 
...
| Pool | 4 Knoten von vROPs | 4 Knoten von vROPs |
...
Die Bereitstellung der vROps-Appliance erfordert sechs IPs aus dem privaten portablen Tools-Teilnetz. Für die Netzkonnektivität erfordert vROps Zugriff auf: 
* vCenter-Appliance
...
Management Packs für vROps erweitern operative Managementfunktionen der vROps-Plattform, um produktspezifische Alerts und Dashboards bereitzustellen. 
...
Die Plug-ins im VMware SDDC Health Management Pack erfassen Metriken für Objekttypen, die in den Plug-ins enthalten sind. Das Management Pack erfasst Statusmetriken für Folgendes: 
* vCenter Server
* Management Pack for NSX for vSphere
* vRealize Automation
* vRealize Operations Manager
...
* [vSAN-Cluster aktualisieren](https://cloud.ibm.com/docs/services/vmwaresolutions/archiref/vum/vum-updating-vsan.html#updating-vsan-clusters){:new_window}
