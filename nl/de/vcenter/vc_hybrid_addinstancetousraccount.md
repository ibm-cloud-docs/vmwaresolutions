...
VMware vCenter Server with Hybridity Bundle-Instanzen, die in Version 2.5 und höher in Ihrem {{site.data.keyword.cloud}}-Konto bereitgestellt wurden, werden Ihrem Konto automatisch hinzugefügt. Diese Instanzen werden von {{site.data.keyword.cloud_notm}} Identity and Access Management (IAM) verwaltet.
...
Weitere Informationen zum Verknüpfen Ihres Nur-IaaS-Kontos mit Ihrem PaaS-Konto finden Sie in [Folgen Sie diesen Schritten, um Ihr IaaS-Konto und Ihr PaaS-Konto zu verknüpfen](https://www.ibm.com/cloud/blog/follow-steps-link-iaas-paas-accounts){:external}.
...
* [Benutzerzugriff mit IAM verwalten](/docs/services/vmwaresolutions?topic=vmware-solutions-iam#iam)
