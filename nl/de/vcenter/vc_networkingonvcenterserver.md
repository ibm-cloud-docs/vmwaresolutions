...
Die Informationen in diesem Abschnitt enthalten Hinweise und Voraussetzungen für den Netzbetrieb Ihrer vCenter Server-Instanzen. Stellen Sie sicher, dass die Voraussetzungen erfüllt sind, damit Ihre Instanzen ordnungsgemäß arbeiten.

## Netzkomponenten für vCenter Server-Instanzen

Informationen zu den Komponenten für den Netzbetrieb, die in Ihrer vCenter Server-Instanz enthalten sind, finden Sie im Abschnitt _Technische Spezifikationen für vCenter Server_ im [Überblick zu vCenter Server](vc_vcenterserveroverview.html).
