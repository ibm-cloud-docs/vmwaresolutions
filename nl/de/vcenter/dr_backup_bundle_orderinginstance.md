...
# Single-node Trial-Instanzen für Datenschutz und Disaster-Recovery bestellen, anzeigen und löschen
{: #dr_backup_bundle_orderinginstance}

Überprüfen Sie die Planungsvoraussetzungen, bevor Sie eine Single-node Trial-Instanz für Datenschutz und Disaster-Recovery bestellen.

Diese Testversion wird nach 90 Tagen automatisch gelöscht. Auf der Seite mit den Instanzdetails wird ein Ablaufcountdown für die Single-node Trial-Instanz für Datenschutz und Disaster-Recovery angezeigt.{:important}

## Voraussetzungen und Planung für die Bestellung von Single-node Trial-Instanzen für Datenschutz und Disaster-Recovery
...
## Vorgehensweise zum Bestellen von Single-node Trial-Instanzen für Datenschutz und Disaster-Recovery
{: #dr_backup_bundle_orderinginstance-procedure}

1. Klicken Sie im {{site.data.keyword.cloud_notm}}-Katalog im linken Navigationsfenster auf **VMware** und anschließend im Abschnitt **Virtuelle VMware-Rechenzentren** auf **Single-node Trial für Datenschutz und Disaster-Recovery**.
2. Klicken Sie auf der Seite **Single-node Trial für Datenschutz und Disaster-Recovery** auf **Weiter**.
...
### Ergebnisse nach dem Bestellen von Single-node Trial-Instanzen für Datenschutz und Disaster-Recovery
...
* Nachdem die Instanz erfolgreich bereitgestellt wurde, sind die Komponenten installiert, die unter [Technische Spezifikationen für Single-node Trial-Instanzen für Datenschutz und Disaster-Recovery](https://test.cloud.ibm.com/docs/services/vmwaresolutions/services?topic=vmware-solutions-dr_backup_bundle_overview#dr_backup_bundle_overview-tech-specs) beschrieben werden.
...
## Vorgehensweise zum Löschen von Single-node Trial-Instanzen für Datenschutz und Disaster-Recovery
{: #dr_backup_bundle_orderinginstance-deleting-procedure}

Wenn Sie eine Single-node Trial-Instanz für Disaster-Recovery löschen, werden die folgenden Komponenten nacheinander freigegeben:
...
Führen Sie folgende Schritte aus, um eine Single-node Trial-Instanz für Datenschutz und Disaster-Recovery zu löschen:
