...
Diese Testversion wird nach 90 Tagen automatisch gelöscht. Auf der Seite mit den Instanzdetails wird ein Ablaufcountdown für die Single-node Trial-Instanz für Datenschutz und Disaster-Recovery angezeigt.
{:important}
...
1. Klicken Sie im {{site.data.keyword.cloud_notm}}-Katalog im linken Navigationsfenster auf das Symbol **VMware** und anschließend im Abschnitt **Virtuelle VMware-Rechenzentren** auf die Karte **Single-node Trial für Datenschutz und Disaster-Recovery**.
