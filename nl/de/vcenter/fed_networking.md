...
Informationen zu den Komponenten für den Netzbetrieb, die in Ihrer VMware Federal-Instanz enthalten sind, finden Sie unter [Technische Spezifikationen für VMware Federal on {{site.data.keyword.cloud}}-Instanzen](/docs/services/vmwaresolutions/vcenter/vc_fed_overview.html#technical-specifications-for-vmware-federal-on-ibm-cloud-instances).
