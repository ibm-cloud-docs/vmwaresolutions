...
{: caption="Tabelle 1. Elemente von vCenter Server with Hybridity Bundle-Instanzen" caption-side="top"}
...
{: caption="Tabelle 2. Statusbeschreibungen der vCenter Server with Hybridity Bundle-Instanzen" caption-side="top"}
...
{: caption="Tabelle 3. Eigenschaften der vCenter Server with Hybridity Bundle-Instanzen" caption-side="top"}
...
{: caption="Tabelle 4. vCenter Server with Hybridity Bundle-Zugriffsinformationen für instanzbezogene Komponenten" caption-side="top"}
...
{: caption="Tabelle 5. Bereitstellungsverlauf für vCenter Server with Hybridity Bundle-Instanz" caption-side="top"}
