...
|----------------------------------------------------------------------------------------|------------------|
| [F5 on {{site.data.keyword.cloud_notm}}](../services/f5_considerations.html)                                 | Ja | V1.9 und höher |
...
| [VMware HCX on {{site.data.keyword.cloud_notm}}](../services/hcx_considerations.html)                        | Ja | V2.3 und höher |
| [Zerto on {{site.data.keyword.cloud_notm}}](../services/addingzertodr.html)                                  | Ja | V1.2 und höher |

## Services zu vCenter Server with Hybridity Bundle-Instanzen hinzufügen

Klicken Sie zum Hinzufügen eines Service zu Ihrer vCenter Server with Hybridity Bundle-Instanz auf die entsprechenden Links in der Tabelle, um die Hinweise zu dem Service zu prüfen und die bereitgestellten Komponenten zu überprüfen. Befolgen Sie anschließend die Hinweise in den Abschnitten zur Bestellung, um Ihre Bestellung aufzugeben.
...
## Services für vCenter Server with Hybridity Bundle-Instanzen anzeigen
...
## Services für vCenter Server with Hybridity Bundle-Instanzen entfernen
