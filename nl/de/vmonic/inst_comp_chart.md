...
<sup>2</sup> Sie können die Anzahl von ESXi-Servern in einem vSAN-Cluster auf maximal 64 erhöhen. Weitere Informationen finden Sie unter _Wie viele ESXi-Server kann ich zu einem Cluster hinzufügen?_ im Abschnitt [Häufig gestellte Fragen zu ESXi-Servern](/docs/services/vmwaresolutions/vmonic/faq_esxi.html).
...
* [Übersicht über vCenter Server Hybridity](/docs/services/vmwaresolutions/vcenter/vc_hybrid_overview.html)
* [Übersicht über VMware vSphere](/docs/services/vmwaresolutions/vsphere/vs_vsphereclusteroverview.html)
