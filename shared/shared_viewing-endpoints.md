...
| Allowlisted IPs and subnets | The list of all allowlisted IP addresses and subnets for the virtual data center. |
...
| Modifying | The allowlisted IPs and subnets are being modified. |
