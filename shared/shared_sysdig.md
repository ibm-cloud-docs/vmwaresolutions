...
{{site.data.keyword.vmwaresolutions_full}} Shared provides an integration with {{site.data.keyword.cloud_notm}} Monitoring for Sysdig which allow you to use a VMware Solutions Shared provided default dashboard to view metrics for your virtual data centers. Alternatively, you can create your own dashboard to visualize performance, volume of usage, and to define alerts to monitor your environment.

{{site.data.keyword.cloud_notm}} Monitoring for Sysdig dashboards allow you to:
...
For more information about the benefits of using IBM Cloud Monitoring with Sysdig, see the *Features* section in the [IBM Cloud Monitoring with Sysdig Getting Started Tutorial](/docs/Monitoring-with-Sysdig#features).

## Provisioning an IBM Cloud Monitoring for Sysdig instance
{: #shared_sysdig-create-instance}

Before you can view platform metrics for your virtual data center, you must order an {{site.data.keyword.cloud_notm}} Monitoring for Sysdig instance within the same region as your virtual data center instance and enable the automatic collection of platform metrics.
...
3. From the instance details page, click the **Actions** drop down and click **Add monitoring**. The {{site.data.keyword.cloud_notm}} Monitoring for Sysdig provisining page displays.
...
2. Click the **IBM** drop down and click **VMware Solutions Shared**.
3. Customize your dashboard. For more information, see [Organizing metric data](/docs/Monitoring-with-Sysdig?topic=Monitoring-with-Sysdig-manage).
...
* [Sysdig Monitoring Integration](/docs/databases-for-postgresql?topic=databases-for-postgresql-sysdig-monitoring)
