...
# Migrating pre-V2.5 Cloud Foundation instances to IBM Cloud accounts
{: #sd_addinstancetousraccount}

VMware Cloud Foundation instances that are deployed in V2.5 and later releases in your {{site.data.keyword.cloud}} account are automatically added to your account and are managed by {{site.data.keyword.cloud_notm}} Identity and Access Management (IAM).
...
3. In the **Cloud Foundation Instances** table, find the pre-V2.5 instance.
