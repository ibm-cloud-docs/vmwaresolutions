...
To view a summary of all the Cloud Foundation instances in your environment, click **Deployed Instances** from the left navigation pane. In the **Cloud Foundation Instances** table, view the summary about the ordered instances:

Table 1. Cloud Foundation instances items
...
Table 3. Cloud Foundation instances property details
...
| AD/DNS FQDN | The AD/DNS server fully qualified domain name<br><br>**Note:** The same administrator password can be used to remote desktop into all of the AD/DNS servers. |
