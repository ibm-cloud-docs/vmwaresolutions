...
# Service dependency map for IBM Cloud for VMware Solutions
...
{: tab-group="service-dependency-data-for-vmware-solutions-Data-and-Control-plane-deployment"}
...
## Customer VMware environment deployment
{: #customer-vmware-environment-deployment}
