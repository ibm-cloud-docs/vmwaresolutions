...
For vCenter Server with NSX-V instances, F5 BIG-IP is supported for the following vSphere versions:
* vSphere 6.7
* vSphere 6.5
...
The current F5 BIG-IP version that is installed is v15.1.3.
{:note}
