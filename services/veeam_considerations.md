...
The current Veeam version that is installed is Veeam Backup and Replication 12.2. The documentation about Veeam 9.5u4b is included for your information if you are using Veeam 9.5u4b.
{: note}
