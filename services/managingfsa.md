...
To manage the FortiGate Security Appliance on {{site.data.keyword.cloud}} service, you must access the FortiGate® 300 series console in one of the following ways:
...
* [Components and considerations for FortiGate Security Appliance on {{site.data.keyword.cloud_notm}}](fsa_considerations.html)
