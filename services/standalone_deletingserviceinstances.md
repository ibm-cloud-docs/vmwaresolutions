...
Ensure that you reviewed all the considerations in [Considerations when deleting on-premises HCX instances](/docs/vmwaresolutions?topic=vmware-solutions-standalone_considerations).
