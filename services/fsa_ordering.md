...
You can order the FortiGate Security Appliance on {{site.data.keyword.cloud}} service while ordering a new instance with the HA-pair of FSA 300 series included or by adding the FSA 300 series to your existing instance.
