...
2. On the **Red Hat OpenShift for VMware** page, click the **About** tab to review the description and technical specifications for {{site.data.keyword.redhat_openshift_notm}} for VMware.
