...
On the edge services cluster, note the following.
...
On the Security and Compliance Readiness Bundle, you can install FortiGate Virtual Appliance on the edge services cluster.
