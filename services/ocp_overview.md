...
* Before you delete the service, you must remove any personal VMs from storage that are deployed with this service. OpenShift only orders personal VMs if it’s not vSAN.
