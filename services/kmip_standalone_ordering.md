...
2. In the **VMware Services** section, click the **KMIP for VMware on IBM Cloud** card.
...
{: caption="Table 1. KMIP for VMware on {{site.data.keyword.cloud_notm}} network service endpoint locations" caption-side="top"}
