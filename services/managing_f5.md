...
For more information about viewing the service details, see [Ordering, viewing, and deleting services for vCenter Server® instances](/docs/vmwaresolutions?topic=vmwaresolutions-vc_addingservices).
