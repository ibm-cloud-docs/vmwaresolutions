...
4. **For vCenter Server with NSX-V instances**, complete the following steps to create a DHCP binding for the worker VM:
...
5. **For vCenter Server with NSX-T instances**, complete the following steps to create a DHCP binding for the worker VM:
  1. Log in to NSX-T.
...
6. **For vCenter Server with NSX-V instances**, complete the following steps to add a worker to the Load Balancer pools:
...
7. **For vCenter Server with NSX-T instances**, complete the following steps to add a worker to the Load Balancer pools:
...
8. Create DNS records for the new worker.
