...
Only the virtual machines (VMs) that were deployed during the initial installation of the HCX instances are deleted. Any node that is deployed after the installation will not be cleaned up.
{:note}

## Related links
{: #hcx_considerations-related}

* [Ordering HCX](/docs/services/vmwaresolutions/services?topic=vmware-solutions-hcx_ordering)
