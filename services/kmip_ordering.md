...
You can order the KMIP for VMware on {{site.data.keyword.cloud_notm}} service while ordering a new instance with the service included or by adding service to your existing instance.
...
* From the {{site.data.keyword.vmwaresolutions_full}} console, when you order a new instance, select **KMIP for VMware on IBM Cloud** in the **Services** section.
* From the {{site.data.keyword.cloud_notm}} catalog, select **KMIP for VMware on {{site.data.keyword.cloud_notm}} service**, specify the service settings, and select **Add to New Instance**.
...
* From the {{site.data.keyword.cloud_notm}} catalog, select **KMIP for VMware on IBM Cloud service**, specify the service settings and select **Add to Existing Instance**.
...
* [KMIP for VMware on IBM Cloud overview](kmip_considerations.html)
