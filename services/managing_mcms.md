...
1. In the {{site.data.keyword.vmwaresolutions_short}} console, scroll down to the **Add-on services** section and click **Managed Services for VMware Workload Transformation** in the **Professional services** category.
