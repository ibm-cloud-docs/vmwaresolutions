...
4. Log in to the console by using the console credentials that you can find on the HyTrust KeyControl on IBM Cloud service details page on the {{site.data.keyword.vmwaresolutions_short}} console.
