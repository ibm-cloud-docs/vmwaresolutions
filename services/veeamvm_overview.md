...
You can install Veeam Backup and Replication 12.3.2 on a bare metal server. This installation is supported only for VMware vSphere® 7.0 with VMware NSX-T™.
