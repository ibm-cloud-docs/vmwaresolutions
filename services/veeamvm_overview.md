...
The Veeam service that is installed is Veeam Availability Suite™ 12.2 (Veeam 12.2).
{: note}
...
You can install Veeam Backup and Replication 12.2 on a bare metal server. This installation is supported only for VMware vSphere® 7.0 with VMware NSX-T™.
...
* VM with Veeam Backup and Replication 12.2 OS Add-on and Veeam Availability Suite™ 12
...
* Single VSI with Veeam Backup and Replication 12.2 OS Add-on and Veeam Availability Suite 12
* Windows Server 2019 Standard Edition (64-bit)
* 4 x 2.0 GHz Cores
* 8 CPUs, 32 GB RAM
...
* Bare metal server with Veeam Backup and Replication 12.2 OS Add-on and Veeam Availability Suite 12
* Windows Server 2019 Standard Edition (64-bit)
* 2 x 2.2 GHz CPU
* 64 GB RAM
