...
3. To specify the instance configuration name, click **Browse configurations** and choose a configuration in the **VMware instance configuration manager**.
...
5. Select the VMware® components for licensing:
...
7. If you selected the **VMware vSAN** component, complete the vSAN™ storage configuration.
...
10. To place the order, make sure that the account to be charged is correct, review and accept the terms, and then click **Create**.
