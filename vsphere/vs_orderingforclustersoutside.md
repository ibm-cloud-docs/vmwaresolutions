...
9. In the **Summary** pane, verify the instance configuration and the estimated price, ensure that the account to be charged is correct, review and accept the terms, and then click **Create**.
