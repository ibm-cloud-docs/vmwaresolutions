...
Price calculations are automatically generated when you access the {{site.data.keyword.vcf-flex-short}} instance order page. Default selections include the Dual Intel® Xeon® Platinum 8260 processor / 48 cores, 2.4 GHz CPU model, and 768 GB RAM.
