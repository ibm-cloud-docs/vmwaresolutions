...
If you are using the VMware vCenter Server® offering, it is recommended to migrate your instances to a v7.x environment. For more information, see the following topics:
