...
VMware Cloud Foundation™ supports the two base architecture models - consolidated and standard. {{site.data.keyword.vcf-vpc}} currently only supports consolidated deployments. 
