...
VMware Cloud Foundation™ supports the two base architecture models - consolidated and standard. Currently, {{site.data.keyword.vcf-vpc}} supports only consolidated deployments.
