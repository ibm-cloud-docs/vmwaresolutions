...
* [Guest OS file restore](https://helpcenter.veeam.com/archive/backup/120/vsphere/guest_file_recovery.html){: external}
* [Application items restore](https://helpcenter.veeam.com/archive/backup/120/vsphere/restore_veeam_explorers.html){: external}
* [Secure restore](https://helpcenter.veeam.com/archive/backup/120/vsphere/av_scan_about.html){: external}
* [Instant file share recovery](https://helpcenter.veeam.com/archive/backup/120/vsphere/performing_instant_file_share_recovery.html){: external}
* [Restore of specific files and folders from NAS backup](https://helpcenter.veeam.com/archive/backup/120/vsphere/file_share_recovery_restore_files_folders.html){: external}
...
* [Configuring a backup repository](https://helpcenter.veeam.com/archive/backup/120/vsphere/repository_mount_server.html){: external}
* [Adding Microsoft Windows Servers](https://helpcenter.veeam.com/archive/backup/120/vsphere/add_windows_server.html){: external}
* [System requirements](https://helpcenter.veeam.com/archive/backup/120/vsphere/system_requirements.html#mount){: external}
