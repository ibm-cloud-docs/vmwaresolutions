...
| Domain name resolution | Uses DNS as described in [Common services design](/docs/services/vmwaresolutions?topic=vmware-solutions-design_commonservice). |
...
The available vSAN features depend on the license edition that you select when you order the instance. For more information, see [VMware vSAN edition comparison](/docs/services/vmwaresolutions?topic=vmware-solutions-solution-appendix#vmware-vsan-edition-comparison).
...
For more information about physical NIC connections, see [Physical host NIC connections](/docs/services/vmwaresolutions?topic=vmware-solutions-design_physicalinfrastructure#design_physicalinfrastructure-host-connect).
...
**Next topic:** [VMware NSX-V design](/docs/services/vmwaresolutions?topic=vmware-solutions-nsx-v-design)
