...
* **Upgrade the VMware vCenter® Server Appliance (VCSA)** – For more information, see [VCSA update and SSO-linked vCenters](/docs/vmwaresolutions?topic=vmwaresolutions-vum-updating-vcsa).
...
3. In the VCSA Management Interface, click **Networking** and click **Manage**.
...
* [{{site.data.keyword.vmwaresolutions_short}} Digital Technical Engagement](https://www.ibm.com/solutions/virtualization){: external}
