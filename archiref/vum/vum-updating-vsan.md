...
Ensure that the VCSA is vCenter 6.5 Patch 2 or newer version before you continue as this fixes some proxy usage issues. For more information, see [VCSA update and SSO-linked vCenters](/docs/vmwaresolutions?topic=vmwaresolutions-vum-updating-vcsa).
