...
* [VMware Update Manager overview](vum-overview.html) - Describes the VUM process and introduces key terms that are needed to understand the operations and UI of the tool.
