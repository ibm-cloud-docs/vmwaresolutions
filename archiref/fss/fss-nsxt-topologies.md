...
Active-passive on the Tier0 provides IPsec capability for access through the HA VIP address. Alternatively, Tier-0 would Border Gateway Protocol (BGP) peer with a vSRX firewall.
