...
![IBM Cloud for VMware Regulated Workloads roles](../../images/fss-boundary.svg "IBM Cloud for VMware Regulated Workloads roles"){: caption="Figure 1. IBM Cloud for VMware Regulated Workloads roles" caption-side="bottom"}
...
## HyTrust RBAC
{: #fss-separation-of-duties-hytrust-rbac}
...
{: #fss-separation-of-duties-network}
...
![Network change workflow](../../images/fss-hytrust-nsxt-flow.svg "Network change workflow"){: caption="Figure 2. Network change workflow" caption-side="bottom"}
