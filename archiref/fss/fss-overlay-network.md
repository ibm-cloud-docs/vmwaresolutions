...
![Workload cross account network](../../images/fss-bank-to-isv.svg "Workload cross account network"){: caption="Figure 2. Workload cross account network" caption-side="bottom"}
