...
The FSS Cloud architecture restores the strict separation of duties that are usually enforced in an on-premises environment.
...
The FSS Cloud architecture spreads the delivery of necessary services across purpose-built regions.
...
**Next topic**: [FSS Cloud use case 2](/docs/services/vmwaresolutions?topic=vmware-solutions-fss-use-case-2)
