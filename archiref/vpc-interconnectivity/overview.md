...
![Interconnectivity solutions with VMware on VPC](../../images/vpc-ryo-diagrams-xcon-vmw-arch.svg "Interconnectivity solutions with VMware on VPC"){: caption="Figure 1. Interconnectivity solutions with VMware® on VPC" caption-side="bottom"}
