...
5. Deploy NSX edge cluster at colocation and create a T0 at the colocation cluster. Create routes on edge nodes for management and TEP traffic through the {{site.data.keyword.dl_short}} path.
