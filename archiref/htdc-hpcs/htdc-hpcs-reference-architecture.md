...
Entrust KeyControl has been deprecated. However, you can still use or delete existing Entrust KeyControl installations. For more information, see [Entrust KeyControl overview](/docs/vmwaresolutions?topic=vmwaresolutions-entrust-kc_considerations).
{: note}
