...
![{{site.data.keyword.cloud_notm}} for VMware Regulated Workloads context](../../images/vrw-v2-context.svg "{{site.data.keyword.cloud_notm}} for VMware Regulated Workloads context"){: caption="Figure 1. {{site.data.keyword.cloud_notm}} for VMware Regulated Workloads context" caption-side="bottom"}
