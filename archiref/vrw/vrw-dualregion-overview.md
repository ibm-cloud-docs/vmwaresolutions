...
![{{site.data.keyword.rw}} dual region overview diagram](../../images/vrw-v2-dualregion-2.svg "{{site.data.keyword.rw}} dual region overview diagram"){: caption="{{site.data.keyword.rw}} dual region overview diagram" caption-side="bottom"}
