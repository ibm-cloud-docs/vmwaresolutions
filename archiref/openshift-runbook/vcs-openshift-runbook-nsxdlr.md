...
{: caption="NSX DLR deployment" caption-side="bottom"}
...
{: caption="NSX DLR anti-affinity rules" caption-side="bottom"}
...
{: caption="Configuration for NSX DLR - interfaces" caption-side="bottom"}
...
{: caption="Configuration for NSX DLR - NSX firewalls" caption-side="bottom"}
...
{: caption="Configuration for NSX Edge - global configuration" caption-side="bottom"}
...
{: caption="Configuration for NSX Edge - DHCP relay" caption-side="bottom"}

| DCHP relay | Value |
| :--- | --- |
| Name  | OpenShift-LS |
| Gateway IP | 192.168.133.1 |
{: caption="Configuration for NSX Edge - DHCP relay agent" caption-side="bottom"}
