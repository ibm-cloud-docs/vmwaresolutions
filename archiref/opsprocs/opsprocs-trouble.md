...
| VM does not power on after cloning or deploying from a template | [Deploying Virtual Machines](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-virtual-machine-administration/deploying-virtual-machinesvsphere-vm-admin.html){: external} looks at issues that affect a VM after it is cloned or deployed from a template. |
...
| Cannot Configure vSphere HA When Using Custom SSL Certificates | After the installation of custom SSL certificates, attempts to enable vSphere HA fail. For more information, see [vCenter Cannot Connect to Managed Hosts](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vcenter-and-host-management/troubleshooting-overview-host-management/troubleshooting-vcenter-server-certificates-host-management/vcenter-server-cannot-connect-to-managed-hosts-host-management.html){: external}. |
...
* [Toubleshooting Overview](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-virtual-machine-administration/troubleshooting-overviewvsphere-vm-admin.html){: external}
* [Troubleshooting with vCenter logs](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-virtual-machine-administration/troubleshooting-overviewvsphere-vm-admin/troubleshooting-with-logsvsphere-vm-admin.html){: external}
...
* [Monitoring Events, Alarms, and Automated Actions](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-monitoring-and-performance/monitoring-events-and-alarms.html){: external}
* [System Log Files](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-monitoring-and-performance/system-log-files.html){: external}
