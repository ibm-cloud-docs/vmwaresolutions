...
| Virtual machine error * | Configure to send email one time when critical for critical appliances. | [Troubleshooting virtual machines](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vsphere-virtual-machine-administration/troubleshooting-virtual-machinesvsphere-vm-admin.html){: external} |
...
| Health status changed * | Configure to send an email one time if status changes to critical. | [Troubleshooting ESX hosts](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-0/vcenter-and-host-management/troubleshooting-overview-host-management/troubleshooting-hosts-host-management.html){: external} |
