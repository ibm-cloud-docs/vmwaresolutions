...
* Service Provisioning - Customers can provision and resize their vCenter Server instances on demand, using the [console](https://cloud.ibm.com/infrastructure/vmware-solutions/console).
