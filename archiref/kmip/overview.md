...
* Integrating your VMware cluster with {{site.data.keyword.cloud_notm}} Key Protect provides you with fully customer-managed keys that you can revoke at any time.
