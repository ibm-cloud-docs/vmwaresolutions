...
- **Zero downtime migration** – a running virtual machine can be moved to (or back from) the cloud using vMotion.
...
Figure 3. VCS with ICP

![VCS with ICP](vcsicp-virtual-icp-deployment-vcs.svg)
