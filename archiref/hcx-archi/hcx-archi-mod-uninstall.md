...
The Hybrid Cloud Gateway and any hybrid service virtual appliances that use the Hybrid Cloud Gateway are removed from both the vCenter and the VCF/VCS Hybrid Cloud Services Cloud.
