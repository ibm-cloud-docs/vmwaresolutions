...
In a self-managed vCenter Server solution, you can reconfigure provisioned backup servers, configure Veeam configuration backups, add more proxy servers, add more {{site.data.keyword.cloud_notm}} File, Block, or Object storage, or add OS agents on virtual machines.
