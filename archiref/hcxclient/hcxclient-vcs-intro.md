...
The VMware HCX on IBM Cloud service enables creating a seamless connection between IBM Cloud for VMware Solutions and an on-premises VMware virtualized datacenter.
...
This connection creates a loosely coupled inter-connectivity between on-premises and IBM Cloud and enables capabilities such as:
