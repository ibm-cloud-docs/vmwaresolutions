...
This document provides a view on the application modernization journey to IBM Cloud, focusing on the network aspects of the following platforms to allow an integrated multi-cloud to be leveraged for application modernization:
...
This document is one of five documents that provides different views on the technologies that are used in the application modernization journey to IBM Cloud:
...
* [vCenter Server and IBM Cloud Private](../vcsicp/vcsicp-intro.html) - This guide is a reference architecture for deploying the following platforms:
  - **VMware vCenter Server on IBM Cloud** - an offering from IBM Cloud for VMware Solutions and is a VMware based platform that is automatically provisioned on IBM Cloud.
...
* [vCenter Server and IBM Cloud Private](../vcsiks/vcsiks-intro.html) - This guide is a reference architecture for deploying the following platforms:
  - **VMware vCenter Server on IBM Cloud** - an offering from IBM Cloud for VMware Solutions and is a VMware based platform that is automatically provisioned on IBM Cloud.
