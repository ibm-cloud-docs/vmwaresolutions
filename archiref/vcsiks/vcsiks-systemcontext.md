...
IBM IKS | IBM resource that manages the IKS Master Node for the service.
...
Watson | If this reference architecture and Acme Skateboards, Watson represents the AI service that is used in the “Concept Car” architecture.
