...
You can add clusters to VMware® Regulated Workloads instances to expand the compute and storage capacity. Within a cluster, you can manage VMware vSphere® ESXi™ servers for better resource allocation and high availability. When no longer needed, delete the added clusters from your instances.

The procedures to add, view, and delete clusters for VMware Regulated Workloads instances are similar to the ones for VMware vCenter Server® instances. For more information, see the following topics:
