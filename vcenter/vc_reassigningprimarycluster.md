...
* Before you reassign your primary cluster, you must migrate all management virtual machines (VMs), NSX edge management VMs, and Usage Meter VMs if you deployed Usage Meter VM.
