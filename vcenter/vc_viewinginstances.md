...
| Location | The {{site.data.keyword.CloudDataCent_notm}} where the instance is hosted.<br><br>**Note:** IBM Cloud for VMware Mission Critical Workloads list locations for each cluster type. |
