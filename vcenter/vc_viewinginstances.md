...
| AD/DNS FQDNs | The AD/DNS server fully qualified domain names.<br><br>**Note:** The same administrator password can be used to remote desktop into all of the AD/DNS servers. |
