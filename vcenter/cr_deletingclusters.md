...
* Whenever possible, delete clusters by using the IBM Cloud® for VMware Solutions console because changes that you make on the VMware vSphere® Web Client are not synchronized with the IBM Cloud for VMware Solutions console. Therefore, delete clusters from Cyber Recovery only for on-premises clusters or clusters that you don't plan to manage in the IBM Cloud for VMware Solutions console.
...
2. In the **Cyber Recovery instances** table, click the instance that you want to delete clusters from.
