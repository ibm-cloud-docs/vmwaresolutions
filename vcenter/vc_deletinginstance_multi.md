...
4. Delete the secondary vCenter Server instance from the {{site.data.keyword.vmwaresolutions_full}} console.
5. Repeat from steps 1 to 4 for all secondary vCenter Server instances in your multi-site configuration.
