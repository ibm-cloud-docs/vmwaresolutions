...
* Confirm that you have a [My VMware](https://customerconnect.vmware.com/site-maintenance){: external} user ID for which to download the required binary files to upgrade. If you don't, contact IBM Support with the upgrade support ticket ID.
