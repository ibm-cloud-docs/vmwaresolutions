...
1. From the {{site.data.keyword.cloud_notm}} catalog, click the **VMware** icon from the left navigation pane and then click the **Single-node Trial for Migration and App Modernization** card in the **VMware Virtual Data Centers** section.
