...
4. Use the on-premises activation key noted in step 1 to activate your on-premises HCX Enterprise Manager VM.
  ...
  For more information, see [HCX Activation and Initial Configuration](https://docs.vmware.com/en/VMware-HCX/services/user-guide/GUID-6A4740C1-2225-444C-8ADC-CBE54F181536.html).
  {:note}
