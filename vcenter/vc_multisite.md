...
Multi-site configuration for vCenter Server instances is supported only to V2.0 and later instances. You cannot link between VMware Cloud Foundation and VMware vCenter Server instances in a multi-site configuration.
{:note}
...
Deleting vCenter Server instances that are part of a multi-site configuration requires special planning. For more information, see [Deleting vCenter Server instances in a multi-site configuration](/docs/services/vmwaresolutions/vcenter/vc_deletinginstance_multi.html).
{:note}
