...
3. In the **Cyber Recovery instances** table, view the list of instances that are provisioned in the selected user account.
...
1. In the **Cyber Recovery instances** table, click an instance name.
...
Before you click **Cyber Recovery console** on the instance summary page to go to the vSphere Web Client and start managing your VMware ESXi™ servers, you must log in to the VPN portal of the {{site.data.keyword.cloud_notm}} data center. Hover over **Cyber Recovery console** and follow the instructions to ensure that you meet all requirements and you completed the necessary steps before you access the vSphere Web Client.
{: important}
