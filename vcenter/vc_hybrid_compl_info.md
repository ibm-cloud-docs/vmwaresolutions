...
* Access is to the VMware management components or to the {{site.data.keyword.cloud_notm}} management components and never to the client virtual machines or applications.
...
* For more information about support tickets, see the [IBM Support Guide](https://www.ibm.com/support/pages/ibm-support-guide) and follow the steps in [Getting help and support](/docs/vmwaresolutions?topic=vmwaresolutions-trbl_support).
...
* While IBM Support is available to assist throughout the lifecycle of the product, support might be limited by the information and access provided by the client.
