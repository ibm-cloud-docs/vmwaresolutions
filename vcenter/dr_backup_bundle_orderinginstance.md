...
keywords: single-node, data protection DR, order data protection DR
...
# Ordering, viewing, and deleting Single-node for Data Protection and Disaster Recovery instances
{: #dr_backup_bundle_orderinginstance}

Review the planning requirements before you order a Single-node for Data Protection and Disaster Recovery instance.

This trial is automatically deleted after 90 days. An expiration countdown for the Single-node for Data Protection and Disaster Recovery instance displays on the instance details page.
{:important}

## Requirements and planning for ordering Single-node for Data Protection and Disaster Recovery instances
...
## Procedure to order Single-node for Data Protection and Disaster Recovery instances
{: #dr_backup_bundle_orderinginstance-procedure}

1. In the {{site.data.keyword.vmwaresolutions_short}} console, click the **Single-node for Data Protection and Disaster Recovery** card in the **Featured Services** section.
2. On the **Single-node for Data Protection and Disaster Recovery** page, complete the steps to request an {{site.data.keyword.cloud_notm}} infrastructure account or provide your existing **User name** and **API key** and click **Retrieve**.
...
### Results after you order Single-node for Data Protection and Disaster Recovery instances
...
* When the instance is successfully deployed, the components that are described in [Technical specifications for Single-node for Data Protection and Disaster Recovery instances](/docs/vmwaresolutions?topic=vmwaresolutions-dr_backup_bundle_overview#dr_backup_bundle_overview-tech-specs) are installed.
...
## Procedure to delete Single-node for Data Protection and Disaster Recovery instances
{: #dr_backup_bundle_orderinginstance-deleting-procedure}

When you delete a Single-node for Disaster Recover instance, the following components are released sequentially:
...
Complete the following steps to delete a Single-node for Data Protection and Disaster Recovery instance:
