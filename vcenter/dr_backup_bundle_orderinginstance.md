...
2. In the **Featured Services** section, click the **Single-node for Data Protection and Disaster Recovery** card.
3. On the **Single-node for Data Protection and Disaster Recovery** page, complete the steps to request an {{site.data.keyword.cloud_notm}} infrastructure account or provide your existing **User name** and **API key** and click **Retrieve**.
